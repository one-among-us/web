var R=Object.defineProperty;var V=(e,n,t)=>n in e?R(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var i=(e,n,t)=>(V(e,typeof n!="symbol"?n+"":n,t),t);import{O as I,V as P,g as d,i as u,a as y,u as z,d as A,_ as $,r as E,o as l,c as h,b as g,e as p,t as T,f as W,h as F,w as O,j as x,v as j,k as m,l as G,T as H,m as U,n as K,F as Y,p as J,q as X,s as q,x as Q,y as Z}from"./index-9c0b7411.js";import{f as B,a as ee,h as _}from"./helper-bc11ede6.js";import{I as te,_ as D,a as ne,R as M}from"./paper-plane-4738150a.js";import{_ as L,S as b}from"./sweetalert2.all-6f8c8ab6.js";import{X as oe}from"./index-6be3cc35-c6b4b8e2.js";var ae=Object.defineProperty,se=Object.getOwnPropertyDescriptor,ie=(e,n,t,a)=>{for(var o=a>1?void 0:a?se(n,t):n,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(n,t,o):r(o))||o);return a&&o&&ae(n,t,o),o};let k=class extends P{constructor(){super(...arguments);i(this,"lang",d());i(this,"i18n",u[d()]);i(this,"people",null)}created(){y(`Language: ${this.lang}`),B(z(A,"people-list.json")).then(n=>n.json()).then(n=>this.people=n)}rand(){if(!this.people)return;const n=this.people[Math.floor(this.people.length*Math.random())];this.$router.push(`/profile/${n.id}`)}};k=ie([I({components:{Icon:te}})],k);const re={class:"textR"};function le(e,n,t,a,o,s){const r=E("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:n[0]||(n[0]=(...w)=>e.rand&&e.rand(...w))},[g(r,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",re,T(e.i18n.random),1)])}const pe=$(k,[["render",le],["__scopeId","data-v-f5ab7655"]]),he=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
...
`;function Te(e,n={}){if(e.hasAttribute("fit-initialized"))return;function t(){const a=n.width??e.parentElement.clientWidth;if(e.clientWidth<=a)return;const o=window.getComputedStyle(e);let s=a/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",n.maxFontSize&&(s=Math.min(s,n.maxFontSize)),n.minFontSize&&(s=Math.max(s,n.minFontSize)),e.style.fontSize=s+"px"}t(),e.addEventListener("resize",t),e.addEventListener("orientationchange",t),e.setAttribute("fit-initialized","y")}var ke=Object.defineProperty,Ce=Object.getOwnPropertyDescriptor,Ie=(e,n,t,a)=>{for(var o=a>1?void 0:a?Ce(n,t):n,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(n,t,o):r(o))||o);return a&&o&&ke(n,t,o),o};let C=class extends P{constructor(){super(...arguments);i(this,"textInputCache","");i(this,"textInputKey");i(this,"showCaptchaPrompt",!1);i(this,"i18n",u[d()]);i(this,"p",{id:"tdor"});i(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(t){this.showCaptchaPrompt=!1;const a={id:this.p.id,content:this.textInput,...t};y(a),b.fire({title:u[d()].nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{b.showLoading(null),ee(W+"/comment/add",{method:"POST",params:a}).then(()=>{this.textInput="",b.fire({title:u[d()].nav_success,text:u[d()].nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:u[d()].nav_ok_1,showCloseButton:!0})}).catch(o=>{F(o),b.fire({title:u[d()].nav_failed,text:u[d()].nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(t){this.textInputCache=t,localStorage.setItem(this.textInputKey,t)}mounted(){this.resizeInput(),oe()}resizeInput(){const t=this.$refs.input;t.style.height="auto",t.style.height=`${t.scrollHeight+18}px`}};C=Ie([I({components:{MarkdownTooltip:D,SubmitPrompt:L}})],C);const Pe={id:"TdorComments",class:"introduction"},$e={id:"add-comment"},Se=["placeholder"],xe={key:0,id:"send-comment-btn"},qe={class:"char-count unselectable"};function ze(e,n,t,a,o,s){const r=ne,w=D,c=L;return l(),h("div",Pe,[g(H,{name:"collapse"},{default:O(()=>[x(p("div",$e,[x(p("textarea",{id:"comment-textarea","onUpdate:modelValue":n[0]||(n[0]=f=>e.textInput=f),placeholder:e.i18n.nav_comment_placeholder,onInput:n[1]||(n[1]=(...f)=>e.resizeInput&&e.resizeInput(...f)),ref:"input"},null,40,Se),[[j,e.textInput]]),e.textInput.length>0?(l(),h("div",xe,[p("span",qe,T(e.textInput.length)+" "+T(e.i18n.nav_comment_status),1),g(r,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):m("",!0),g(w,{"text-area-id":"comment-textarea"})],512),[[G,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(l(),U(c,{key:0,onSubmit:e.submitRequest,onClose:n[2]||(n[2]=f=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):m("",!0)])}const Ae=$(C,[["render",ze]]);var Ee=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,S=(e,n,t,a)=>{for(var o=a>1?void 0:a?Oe(n,t):n,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(n,t,o):r(o))||o);return a&&o&&Ee(n,t,o),o};let v=class extends P{constructor(){super(...arguments);i(this,"clicked","");i(this,"showAdd",!1);i(this,"lang",d());i(this,"tdorTop",_(this.lang==="zh_hans"?he:this.lang==="zh_hant"?de:ce));i(this,"tdorCommentView",_(this.lang==="zh_hans"?ue:this.lang==="zh_hant"?fe:me));i(this,"htmlTop",_(this.lang==="zh_hans"?ge:this.lang==="zh_hant"?we:ve));i(this,"htmlBottom",_(this.lang==="zh_hans"?_e:this.lang==="zh_hant"?be:ye));i(this,"people",null);i(this,"bookmarkTexts");i(this,"bookmark")}isDeadlinePassed(){const t=new Date(2024,2,27,16,0);return new Date>t}isShowCommentsEntry(){const t=new Date(2024,2,31,12,0),a=new Date(2024,3,6,12,0),o=new Date;return o>t&&o<a}updated(){if(this.bookmark!=null){const t=this.bookmark[0].offsetWidth-10;for(const a of this.bookmarkTexts)Te(a,{width:t})}}created(){y(`Language: ${this.lang}`),B(z(A,"people-list.json")).then(t=>t.text()).then(t=>{this.people=JSON.parse(t)})}switchPage(t){y(`switchPage(${t.id})`),this.$router.push(`/profile/${t.id}`)}profileUrl(t){return K(t.profileUrl,t.id)}};S([M()],v.prototype,"bookmarkTexts",2);S([M()],v.prototype,"bookmark",2);v=S([I({components:{TdorComments:Ae}})],v);const N=e=>(Q("data-v-aeabbf5c"),e=e(),Z(),e),He=["innerHTML"],Ue=["innerHTML"],Be=["innerHTML"],De={key:3,id:"profiles",class:"unselectable"},Me=N(()=>p("div",{class:"back"},null,-1)),Le=["href","onClick"],Ne=["src","onClick"],Re={key:0,class:"profile"},Ve=N(()=>p("div",{class:"back add fbox-vcenter"},"+",-1)),We=[Ve],Fe=["innerHTML"];function je(e,n,t,a,o,s){const r=E("TdorComments"),w=pe;return l(),h("div",null,[p("div",{id:"home",class:X(e.clicked?"clicked":"")},[e.isShowCommentsEntry()?(l(),h("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorCommentView},null,8,He)):m("",!0),e.isDeadlinePassed()?m("",!0):(l(),h("div",{key:1,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,Ue)),e.isDeadlinePassed()?m("",!0):(l(),U(r,{key:2})),p("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,Be),g(w),e.people?(l(),h("div",De,[(l(!0),h(Y,null,J(e.people,(c,f)=>(l(),h("div",{class:"profile",key:f},[Me,p("a",{href:`/profile/${c.id}`,onClick:q(()=>!1,["exact","prevent","stop"])},[g(H,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:O(()=>[e.clicked!==c.name?(l(),h("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:q(()=>(e.clicked||(e.clicked=c.name),!1),["exact"])},null,8,Ne)):m("",!0)]),_:2},1032,["onAfterLeave"])],8,Le),p("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},T(c.name),513),p("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(l(),h("div",Re,We)):m("",!0)])):m("",!0),p("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,Fe)],2)])}const tt=$(v,[["render",je],["__scopeId","data-v-aeabbf5c"]]);export{tt as default};
