var D=Object.defineProperty;var V=(e,t,n)=>t in e?D(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var i=(e,t,n)=>(V(e,typeof t!="symbol"?t+"":t,n),n);import{O as I,V as P,g as d,i as u,a as y,u as z,d as A,_ as $,r as E,o as l,c as h,b as g,e as p,t as T,f as W,h as F,w as O,j as S,v as j,k as m,l as G,T as H,m as U,n as K,F as Y,p as J,q as X,s as q,x as Q,y as Z}from"./index-0c3f02cd.js";import{f as B,a as ee,h as _}from"./helper-9dc28496.js";import{I as te,_ as M,a as ne,R as L}from"./paper-plane-75472bd4.js";import{_ as N,S as b}from"./sweetalert2.all-1130f155.js";import{X as oe}from"./index-6be3cc35-fdedd7e6.js";var ae=Object.defineProperty,se=Object.getOwnPropertyDescriptor,ie=(e,t,n,a)=>{for(var o=a>1?void 0:a?se(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&ae(t,n,o),o};let k=class extends P{constructor(){super(...arguments);i(this,"lang",d());i(this,"i18n",u[d()]);i(this,"people",null)}created(){y(`Language: ${this.lang}`),B(z(A,"people-list.json")).then(t=>t.json()).then(t=>this.people=t)}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];this.$router.push(`/profile/${t.id}`)}};k=ie([I({components:{Icon:te}})],k);const re={class:"textR"};function le(e,t,n,a,o,s){const r=E("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...w)=>e.rand&&e.rand(...w))},[g(r,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",re,T(e.i18n.random),1)])}const pe=$(k,[["render",le],["__scopeId","data-v-f5ab7655"]]),he=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
...
<p>写一封来信：</p>
`,de=`<p><strong>轉眼三月過半。3月31日又是一度跨性別現身日。</strong></p>
...
<p>寫一封來信：</p>
`,ce=`<p><strong>As the first month of spring passes its halfway mark, March 31 marks another Transgender Day of Visibility.</strong></p>
...
<p>Write a letter:</p>
`,ue=`<p>[!Note] 『2024年 跨性别现身日晚会』<a href="/profile/tdor">来信集合文字版</a>已经开放阅读，感谢大家的来信。</p>
...
`,fe=`<p>[!Note] 『2024年 跨性別現身日晚會<a href="/profile/tdor">留言集文字版</a>現已開放閱讀，感謝大家的來信。</p>
`,ge=`<p>我一直记得《寻梦环游记》里面一句话：死亡不是生命的终点，遗忘才是。那些离开了我们的人，或许正在某个地方对我们说：「请你们不要忘记我。」</p>
...
`,we=`<p>我一直記得《尋夢環遊記》裏面一句話：死亡不是生命的終點，遺忘纔是。那些離開了我們的人，或許正在某個地方對我們說：「請你們不要忘記我。」</p>
...
`,ve=`<p>I always remember a sentence in &quot;Coco&quot;: Death is not the end of life, but oblivion is. Those who have left us, perhaps somewhere, are whispering to us: &quot;Please don&#39;t forget me.&quot;    </p>
...
`,ye=`<h1 id="suicide-prevention">Suicide Prevention</h1>
...
`;function Te(e,t={}){if(e.hasAttribute("fit-initialized"))return;function n(){const a=t.width??e.parentElement.clientWidth;if(e.clientWidth<=a)return;const o=window.getComputedStyle(e);let s=a/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",t.maxFontSize&&(s=Math.min(s,t.maxFontSize)),t.minFontSize&&(s=Math.max(s,t.minFontSize)),e.style.fontSize=s+"px"}n(),e.addEventListener("resize",n),e.addEventListener("orientationchange",n),e.setAttribute("fit-initialized","y")}var ke=Object.defineProperty,Ce=Object.getOwnPropertyDescriptor,Ie=(e,t,n,a)=>{for(var o=a>1?void 0:a?Ce(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&ke(t,n,o),o};let C=class extends P{constructor(){super(...arguments);i(this,"textInputCache","");i(this,"textInputKey");i(this,"showCaptchaPrompt",!1);i(this,"i18n",u[d()]);i(this,"p",{id:"tdor"});i(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(n){this.showCaptchaPrompt=!1;const a={id:this.p.id,content:this.textInput,...n};y(a),b.fire({title:u[d()].nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{b.showLoading(null),ee(W+"/comment/add",{method:"POST",params:a}).then(()=>{this.textInput="",b.fire({title:u[d()].nav_success,text:u[d()].nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:u[d()].nav_ok_1,showCloseButton:!0})}).catch(o=>{F(o),b.fire({title:u[d()].nav_failed,text:u[d()].nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(n){this.textInputCache=n,localStorage.setItem(this.textInputKey,n)}mounted(){this.resizeInput(),oe()}resizeInput(){const n=this.$refs.input;n.style.height="auto",n.style.height=`${n.scrollHeight+18}px`}};C=Ie([I({components:{MarkdownTooltip:M,SubmitPrompt:N}})],C);const Pe={id:"TdorComments",class:"introduction"},$e={id:"add-comment"},xe=["placeholder"],Se={key:0,id:"send-comment-btn"},qe={class:"char-count unselectable"};function ze(e,t,n,a,o,s){const r=ne,w=M,c=N;return l(),h("div",Pe,[g(H,{name:"collapse"},{default:O(()=>[S(p("div",$e,[S(p("textarea",{id:"comment-textarea","onUpdate:modelValue":t[0]||(t[0]=f=>e.textInput=f),placeholder:e.i18n.nav_comment_placeholder,onInput:t[1]||(t[1]=(...f)=>e.resizeInput&&e.resizeInput(...f)),ref:"input"},null,40,xe),[[j,e.textInput]]),e.textInput.length>0?(l(),h("div",Se,[p("span",qe,T(e.textInput.length)+" "+T(e.i18n.nav_comment_status),1),g(r,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):m("",!0),g(w,{"text-area-id":"comment-textarea"})],512),[[G,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(l(),U(c,{key:0,onSubmit:e.submitRequest,onClose:t[2]||(t[2]=f=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):m("",!0)])}const Ae=$(C,[["render",ze]]);var Ee=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,x=(e,t,n,a)=>{for(var o=a>1?void 0:a?Oe(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&Ee(t,n,o),o};let v=class extends P{constructor(){super(...arguments);i(this,"clicked","");i(this,"showAdd",!1);i(this,"lang",d());i(this,"tdorTop",_(this.lang==="zh_hans"?he:this.lang==="zh_hant"?de:ce));i(this,"tdorCommentView",_(this.lang==="zh_hans"?ue:this.lang==="zh_hant"?fe:me));i(this,"htmlTop",_(this.lang==="zh_hans"?ge:this.lang==="zh_hant"?we:ve));i(this,"htmlBottom",_(this.lang==="zh_hans"?_e:this.lang==="zh_hant"?be:ye));i(this,"people",null);i(this,"bookmarkTexts");i(this,"bookmark")}isDeadlinePassed(){return!0}isShowCommentsEntry(){return!0}updated(){if(this.bookmark!=null){const n=this.bookmark[0].offsetWidth-10;for(const a of this.bookmarkTexts)Te(a,{width:n})}}created(){y(`Language: ${this.lang}`),B(z(A,"people-home-list.json")).then(n=>n.text()).then(n=>{this.people=JSON.parse(n)})}switchPage(n){y(`switchPage(${n.id})`),this.$router.push(`/profile/${n.id}`)}profileUrl(n){return K(n.profileUrl,n.id)}};x([L()],v.prototype,"bookmarkTexts",2);x([L()],v.prototype,"bookmark",2);v=x([I({components:{TdorComments:Ae}})],v);const R=e=>(Q("data-v-886d93b2"),e=e(),Z(),e),He=["innerHTML"],Ue=["innerHTML"],Be=["innerHTML"],Me={key:3,id:"profiles",class:"unselectable"},Le=R(()=>p("div",{class:"back"},null,-1)),Ne=["href","onClick"],Re=["src","onClick"],De={key:0,class:"profile"},Ve=R(()=>p("div",{class:"back add fbox-vcenter"},"+",-1)),We=[Ve],Fe=["innerHTML"];function je(e,t,n,a,o,s){const r=E("TdorComments"),w=pe;return l(),h("div",null,[p("div",{id:"home",class:X(e.clicked?"clicked":"")},[e.isShowCommentsEntry()?(l(),h("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorCommentView},null,8,He)):m("",!0),e.isDeadlinePassed()?m("",!0):(l(),h("div",{key:1,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,Ue)),e.isDeadlinePassed()?m("",!0):(l(),U(r,{key:2})),p("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,Be),g(w),e.people?(l(),h("div",Me,[(l(!0),h(Y,null,J(e.people,(c,f)=>(l(),h("div",{class:"profile",key:f},[Le,p("a",{href:`/profile/${c.id}`,onClick:q(()=>!1,["exact","prevent","stop"])},[g(H,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:O(()=>[e.clicked!==c.name?(l(),h("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:q(()=>(e.clicked||(e.clicked=c.name),!1),["exact"])},null,8,Re)):m("",!0)]),_:2},1032,["onAfterLeave"])],8,Ne),p("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},T(c.name),513),p("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(l(),h("div",De,We)):m("",!0)])):m("",!0),p("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,Fe)],2)])}const tt=$(v,[["render",je],["__scopeId","data-v-886d93b2"]]);export{tt as default};
