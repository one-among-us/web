var O=Object.defineProperty;var C=(e,n,t)=>n in e?O(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var s=(e,n,t)=>(C(e,typeof n!="symbol"?n+"":n,t),t);import{O as _,V as y,g as m,i as U,a as f,u as k,d as T,_ as x,o as p,c as h,b as l,t as E,p as q,e as z,r as H,f as w,F as L,h as R,j as u,n as B,w as v,k as W,T as F}from"./index-5c431a7d.js";import{f as P}from"./helper-32851c1e.js";import{R as $}from"./Ref-33086be0.js";var I=Object.defineProperty,M=Object.getOwnPropertyDescriptor,N=(e,n,t,o)=>{for(var a=o>1?void 0:o?M(n,t):n,i=e.length-1,r;i>=0;i--)(r=e[i])&&(a=(o?r(n,t,a):r(a))||a);return o&&a&&I(n,t,a),a};let g=class extends y{constructor(){super(...arguments);s(this,"lang",m());s(this,"i18n",U[m()]);s(this,"people",null)}created(){f(`Language: ${this.lang}`),P(k(T,"people-list.json")).then(n=>n.text()).then(n=>{this.people=JSON.parse(n)})}rand(){if(!this.people)return;const n=this.people[Math.floor(this.people.length*Math.random())];this.$router.push(`/profile/${n.id}`)}};g=N([_({components:{}})],g);const j=e=>(q("data-v-fba4f2e6"),e=e(),z(),e),D=j(()=>l("div",{class:"iconR"},"🔀",-1)),V={class:"textR"};function G(e,n,t,o,a,i){return p(),h("button",{class:"random shadow",onClick:n[0]||(n[0]=(...r)=>e.rand&&e.rand(...r))},[D,l("div",V,E(e.i18n.random),1)])}const J=x(g,[["render",G],["__scopeId","data-v-fba4f2e6"]]),Y=`<blockquote>
...
`,X=`<h1 id="拒绝对跨性别的暴力">拒绝对跨性别的暴力</h1>
...
`,Z=`<h1 id="拒絕對跨性別的暴力">拒絕對跨性別的暴力</h1>
...
`;function ne(e,n={}){if(e.hasAttribute("fit-initialized"))return;function t(){const o=n.width??e.parentElement.clientWidth;if(e.clientWidth<=o)return;const a=window.getComputedStyle(e);let i=o/e.clientWidth*parseFloat(a.fontSize);e.style.height=e.clientHeight+"px",n.maxFontSize&&(i=Math.min(i,n.maxFontSize)),n.minFontSize&&(i=Math.max(i,n.minFontSize)),e.style.fontSize=i+"px"}t(),e.addEventListener("resize",t),e.addEventListener("orientationchange",t),e.setAttribute("fit-initialized","y")}var te=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,b=(e,n,t,o)=>{for(var a=o>1?void 0:o?ae(n,t):n,i=e.length-1,r;i>=0;i--)(r=e[i])&&(a=(o?r(n,t,a):r(a))||a);return o&&a&&te(n,t,a),a};let d=class extends y{constructor(){super(...arguments);s(this,"clicked","");s(this,"showAdd",!1);s(this,"lang",m());s(this,"htmlTop",this.lang==="zh_hans"?Y:this.lang==="zh_hant"?K:Q);s(this,"htmlBottom",this.lang==="zh_hans"?X:this.lang==="zh_hant"?Z:ee);s(this,"people",null);s(this,"bookmarkTexts");s(this,"bookmark")}updated(){if(this.bookmark!=null){const t=this.bookmark[0].offsetWidth-10;for(const o of this.bookmarkTexts)ne(o,{width:t})}}created(){f(`Language: ${this.lang}`),P(k(T,"people-list.json")).then(t=>t.text()).then(t=>{this.people=JSON.parse(t)})}switchPage(t){f(`switchPage(${t.id})`),this.$router.push(`/profile/${t.id}`)}profileUrl(t){return H(t.profileUrl,t.id)}};b([$()],d.prototype,"bookmarkTexts",2);b([$()],d.prototype,"bookmark",2);d=b([_({})],d);const A=e=>(q("data-v-c4f7ab04"),e=e(),z(),e),oe=["innerHTML"],ie={key:0,id:"profiles",class:"unselectable"},se=A(()=>l("div",{class:"back"},null,-1)),re=["href","onClick"],le=["src","onClick"],pe={key:0,class:"profile"},he=A(()=>l("div",{class:"back add fbox-vcenter"},"+",-1)),ce=[he],de=["innerHTML"];function ue(e,n,t,o,a,i){const r=J;return p(),h("div",null,[l("div",{id:"home",class:B(e.clicked?"clicked":"")},[l("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,oe),w(r),e.people?(p(),h("div",ie,[(p(!0),h(L,null,R(e.people,(c,S)=>(p(),h("div",{class:"profile",key:S},[se,l("a",{href:`/profile/${c.id}`,onClick:v(()=>!1,["exact","prevent","stop"])},[w(F,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:W(()=>[e.clicked!==c.name?(p(),h("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:v(()=>(e.clicked||(e.clicked=c.name),!1),["exact"])},null,8,le)):u("",!0)]),_:2},1032,["onAfterLeave"])],8,re),l("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},E(c.name),513),l("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(p(),h("div",pe,ce)):u("",!0)])):u("",!0),l("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,de)],2)])}const ve=x(d,[["render",ue],["__scopeId","data-v-c4f7ab04"]]);export{ve as default};
