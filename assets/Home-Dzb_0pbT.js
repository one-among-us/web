var W=Object.defineProperty;var F=(e,t,n)=>t in e?W(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var s=(e,t,n)=>(F(e,typeof t!="symbol"?t+"":t,n),n);import{C,V as I,t as c,u as $,d as z,r as A,_ as S,a as E,o as l,c as h,b as f,e as p,f as y,i as _,S as v,g as R,h as D,w as U,j as q,v as j,k as u,l as G,T as H,m as B,n as J,p as K,q as M,F as Y,s as Q,x as X,y as x,z as Z,A as ee}from"./index-Db1DBaww.js";import{f as L,a as te,h as b}from"./helper-DxQjT9Gx.js";import{I as ne,_ as O,a as oe}from"./paper-plane-DeWy4N8a.js";import{_ as N}from"./SubmitPrompt-DisHSyIQ.js";import{J as ae}from"./index-ab8010ff-DEQpY3AD.js";var se=(e,t,n,i)=>{for(var o=t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=r(o)||o);return o};let k=class extends I{constructor(){super(...arguments);s(this,"i18n",c);s(this,"people",null)}created(){L($(z,"people-list.json")).then(t=>t.json()).then(t=>this.people=t)}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];A.push(`/profile/${t.id}`)}};k=se([C({components:{Icon:ne}})],k);const ie={class:"textR"};function re(e,t,n,i,o,a){const r=E("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...g)=>e.rand&&e.rand(...g))},[f(r,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",ie,y(e.i18n.random),1)])}const le=S(k,[["render",re],["__scopeId","data-v-4e3fc4bd"]]),pe=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
