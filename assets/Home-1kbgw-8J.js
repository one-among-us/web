var te=Object.defineProperty;var ne=(e,t,n)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var r=(e,t,n)=>(ne(e,typeof t!="symbol"?t+"":t,n),n);import{C as y,V as _,t as d,_ as k,o as l,c as h,a as p,b as w,F as S,d as R,r as L,I as V,e as M,f,u as $,g as q,i as B,S as T,h as oe,j as ae,w as W,k as H,v as se,l as u,m as ie,T as j,n as I,p as P,q as re,s as le,x as F,y as N,z as pe,A as D,B as he,D as de}from"./index-BphV3Mbe.js";import{f as J,a as ce,h as C,g as ue,s as me,b as fe}from"./helper-D7I4-crN.js";import{_ as Y,a as ge,i as we}from"./paper-plane-D55iJdB4.js";import{_ as G}from"./SubmitPrompt-DahtFN_W.js";import{J as ve}from"./index-ab8010ff-CB5wqpHt.js";var be=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let z=class extends _{getText(){return localStorage.getItem("easterEggMode")?parseInt(localStorage.getItem("easterEggMode"))==0?d.loading.loading:d.loading.easter[Math.random()*d.loading.easter.length|0]:d.loading.loading}};z=be([y({})],z);const ye={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",style:{margin:"auto",background:"transparent",display:"block"},width:"150px",height:"150px",viewBox:"0 0 66 66",preserveAspectRatio:"xMidYMid",class:"rotating"},_e=p("circle",{class:"path",cx:"33",cy:"33",r:"30","stroke-width":"4",stroke:"#70512a","stroke-dasharray":"50.26548245743669 50.26548245743669",fill:"none","stroke-linecap":"round"},null,-1),ke=[_e],Te=["textContent"];function Ce(e,t,n,s,o,a){return l(),h(S,null,[(l(),h("svg",ye,ke)),p("div",{textContent:w(e.getText()),class:"loadingMessage"},null,8,Te)],64)}const K=k(z,[["render",Ce]]);var $e=Object.defineProperty,Ie=Object.getOwnPropertyDescriptor,O=(e,t,n,s)=>{for(var o=s>1?void 0:s?Ie(t,n):t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=(s?i(t,n,o):i(o))||o);return s&&o&&$e(t,n,o),o};let v=class extends _{constructor(){super(...arguments);r(this,"t",d);r(this,"birth",null);r(this,"id");r(this,"name")}goBirth(){L.push(`/profile/${this.id}`)}};O([R({required:!0})],v.prototype,"id",2);O([R({required:!0})],v.prototype,"name",2);v=O([y({components:{Icon:V}})],v);const xe={class:"textR"};function Pe(e,t,n,s,o,a){const i=M("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...m)=>e.goBirth&&e.goBirth(...m))},[f(i,{class:"iconR",icon:"tabler:candy"}),p("span",xe,w(e.t.birthday.birthday.replace("{0}",e.name)),1)])}const Q=k(v,[["render",Pe],["__scopeId","data-v-6974fcc1"]]);var Se=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let A=class extends _{constructor(){super(...arguments);r(this,"i18n",d);r(this,"people",null)}created(){J($(q,"people-list.json")).then(t=>t.json()).then(t=>this.people=t)}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];L.push(`/profile/${t.id}`)}};A=Se([y({components:{Icon:V}})],A);const qe={class:"textR"};function Be(e,t,n,s,o,a){const i=M("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...m)=>e.rand&&e.rand(...m))},[f(i,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",qe,w(e.i18n.random),1)])}const X=k(A,[["render",Be],["__scopeId","data-v-1bfe4235"]]),ze=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
...
<p>写一封来信：</p>
`,Ae=`<p><strong>轉眼三月過半。3月31日又是一度跨性別現身日。</strong></p>
...
<p>寫一封來信：</p>
`,Ee=`<p><strong>As the first month of spring passes its halfway mark, March 31 marks another Transgender Day of Visibility.</strong></p>
...
`,Oe=`<p>[!Note] 『2024年 跨性別現身日晚會<a href="/profile/tdor">留言集文字版</a>現已開放閱讀，感謝大家的來信。</p>
`,Ue=`<p>我一直记得《寻梦环游记》里面一句话：死亡不是生命的终点，遗忘才是。那些离开了我们的人，或许正在某个地方对我们说：「请你们不要忘记我。」</p>
...
`,Ne=`<p>I always remember a sentence in &quot;Coco&quot;: Death is not the end of life, but oblivion is. Those who have left us, perhaps somewhere, are whispering to us: &quot;Please don&#39;t forget me.&quot;    </p>
...
`;function We(e,t={}){if(e.hasAttribute("fit-initialized"))return;function n(){const s=t.width??e.parentElement.clientWidth;if(e.clientWidth<=s)return;const o=window.getComputedStyle(e);let a=s/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",t.maxFontSize&&(a=Math.min(a,t.maxFontSize)),t.minFontSize&&(a=Math.max(a,t.minFontSize)),e.style.fontSize=a+"px"}n(),e.addEventListener("resize",n),e.addEventListener("orientationchange",n),e.setAttribute("fit-initialized","y")}var je=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let E=class extends _{constructor(){super(...arguments);r(this,"textInputCache","");r(this,"textInputKey");r(this,"showCaptchaPrompt",!1);r(this,"t",d);r(this,"p",{id:"tdor"});r(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(n){this.showCaptchaPrompt=!1;const s={id:this.p.id,content:this.textInput,...n};B(s),T.fire({title:d.nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{T.showLoading(null),ce(oe+"/comment/add",{method:"POST",params:s}).then(()=>{this.textInput="",T.fire({title:d.nav_success,text:d.nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:d.nav_ok_1,showCloseButton:!0})}).catch(o=>{ae(o),T.fire({title:d.nav_failed,text:d.nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(n){this.textInputCache=n,localStorage.setItem(this.textInputKey,n)}mounted(){this.resizeInput(),ve()}resizeInput(){const n=this.$refs.input;n.style.height="auto",n.style.height=`${n.scrollHeight+18}px`}};E=je([y({components:{MarkdownTooltip:Y,SubmitPrompt:G}})],E);const Fe={id:"TdorComments",class:"introduction"},Je={id:"add-comment"},Ye=["placeholder"],Ge={key:0,id:"send-comment-btn"},Ke={class:"char-count unselectable"};function Qe(e,t,n,s,o,a){const i=ge,m=Y,x=G;return l(),h("div",Fe,[f(j,{name:"collapse"},{default:W(()=>[H(p("div",Je,[H(p("textarea",{id:"comment-textarea","onUpdate:modelValue":t[0]||(t[0]=g=>e.textInput=g),placeholder:e.t.nav_comment_placeholder,onInput:t[1]||(t[1]=(...g)=>e.resizeInput&&e.resizeInput(...g)),ref:"input"},null,40,Ye),[[se,e.textInput]]),e.textInput.length>0?(l(),h("div",Ge,[p("span",Ke,w(e.textInput.length)+" "+w(e.t.nav_comment_status),1),f(i,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):u("",!0),f(m,{"text-area-id":"comment-textarea"})],512),[[ie,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(l(),I(x,{key:0,onSubmit:e.submitRequest,onClose:t[2]||(t[2]=g=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):u("",!0)])}const Xe=k(E,[["render",Qe]]);var Ze=Object.defineProperty,et=Object.getOwnPropertyDescriptor,U=(e,t,n,s)=>{for(var o=s>1?void 0:s?et(t,n):t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=(s?i(t,n,o):i(o))||o);return s&&o&&Ze(t,n,o),o};let b=class extends _{constructor(){super(...arguments);r(this,"clicked","");r(this,"showAdd",!1);r(this,"isLoading",!0);r(this,"lang",P());r(this,"tdorTop",C(this.lang==="zh_hans"?ze:this.lang==="zh_hant"?Ae:Ee));r(this,"tdorCommentView",C(this.lang==="zh_hans"?Le:this.lang==="zh_hant"?Oe:Me));r(this,"htmlTop",C(this.lang==="zh_hans"?Ue:this.lang==="zh_hant"?He:Ne));r(this,"htmlBottom",C(this.lang==="zh_hans"?De:this.lang==="zh_hant"?Re:Ve));r(this,"people",null);r(this,"birthdayList",[]);r(this,"bookmarkTexts");r(this,"bookmark")}isDeadlinePassed(){return!0}isShowCommentsEntry(){return!1}updated(){if(this.bookmark!=null){const n=this.bookmark[0].offsetWidth-10;for(const s of this.bookmarkTexts)We(s,{width:n})}}created(){B(`Language: ${this.lang}`),J($(q,"people-home-list.json")).then(n=>n.text()).then(n=>this.people=we()&&ue()<.4?me(JSON.parse(n)):JSON.parse(n)),fetch($(q,"birthday-list.json")).then(n=>n.json()).then(n=>{for(const s of n){const o=new Date(s[1]),a=new Date;if(o.getDate()==a.getDate()&&o.getMonth()==a.getMonth()){const i=JSON.parse(fe($(re(s[0]),P()=="zh_hans"?"info.json":`info.${P()}.json`)));this.birthdayList.push([s[0],i.name])}}console.log(this.birthdayList)})}switchPage(n){B(`switchPage(${n.id})`),L.push(`/profile/${n.id}`)}profileUrl(n){return le(n.profileUrl,n.id)}};U([F()],b.prototype,"bookmarkTexts",2);U([F()],b.prototype,"bookmark",2);b=U([y({components:{TdorComments:Xe,Loading:K,RandomPerson:X,BirthdayButton:Q}})],b);const Z=e=>(he("data-v-13b49c4b"),e=e(),de(),e),tt=["innerHTML"],nt=["innerHTML"],ot=["innerHTML"],at={class:"randomButtons"},st={key:4,id:"profiles",class:"unselectable"},it=Z(()=>p("div",{class:"back"},null,-1)),rt=["href"],lt=["src","onClick"],pt={key:0,class:"profile"},ht=Z(()=>p("div",{class:"back add fbox-vcenter"},"+",-1)),dt=[ht],ct=["innerHTML"];function ut(e,t,n,s,o,a){const i=M("TdorComments"),m=X,x=Q,g=K;return l(),h("div",null,[p("div",{id:"home",class:pe(e.clicked?"clicked":"")},[e.isShowCommentsEntry()?(l(),h("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorCommentView},null,8,tt)):u("",!0),e.isDeadlinePassed()?u("",!0):(l(),h("div",{key:1,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,nt)),e.isDeadlinePassed()?u("",!0):(l(),I(i,{key:2})),p("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,ot),p("div",at,[f(m,{class:"randomP"}),(l(!0),h(S,null,N(e.birthdayList,c=>(l(),I(x,{class:"randomP",key:c[0],id:c[0],name:c[1]},null,8,["id","name"]))),128))]),e.isLoading?(l(),I(g,{key:3})):u("",!0),e.people?(l(),h("div",st,[(l(!0),h(S,null,N(e.people,(c,ee)=>(l(),h("div",{class:"profile",key:ee},[it,p("a",{href:`/profile/${c.id}`,onClick:D(()=>!1,["exact","prevent","stop"])},[f(j,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:W(()=>[e.clicked!==c.name?(l(),h("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:D(()=>(e.clicked||(e.clicked=c.name),!1),["exact"]),onLoad:t[0]||(t[0]=mt=>e.isLoading=!1)},null,40,lt)):u("",!0)]),_:2},1032,["onAfterLeave"])],8,rt),p("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},w(c.name),513),p("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(l(),h("div",pt,dt)):u("",!0)])):u("",!0),p("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,ct)],2)])}const Tt=k(b,[["render",ut],["__scopeId","data-v-13b49c4b"]]);export{Tt as default};
