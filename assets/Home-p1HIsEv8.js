var ne=Object.defineProperty;var oe=(e,t,n)=>t in e?ne(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var r=(e,t,n)=>(oe(e,typeof t!="symbol"?t+"":t,n),n);import{C as _,V as k,t as d,_ as T,o as l,c as h,a as p,b as w,F as S,d as j,r as M,I as F,e as O,f,g as J,u as I,h as q,i as B,S as C,j as ae,k as se,l as ie,w as z,m as D,v as re,n as u,p as le,T as G,q as v,s as P,x as $,y as N,z as pe,A as he,B as de,D as ce,E as ue,G as me,H as K,J as fe,K as R,L as ge,M as we,N as V,O as ve,P as ye}from"./index-TU-luPLU.js";import{_ as Y,a as be,i as W}from"./paper-plane-CA-KPs_T.js";import{_ as Q}from"./SubmitPrompt-BiED1xPO.js";import{J as _e}from"./index-ab8010ff-0_ruNHFN.js";var ke=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let E=class extends k{getText(){return localStorage.getItem("easterEggMode")?parseInt(localStorage.getItem("easterEggMode"))==0?d.loading.loading:d.loading.easter[Math.random()*d.loading.easter.length|0]:d.loading.loading}};E=ke([_({})],E);const Te={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",style:{margin:"auto",background:"transparent",display:"block"},width:"150px",height:"150px",viewBox:"0 0 66 66",preserveAspectRatio:"xMidYMid",class:"rotating"},Ce=p("circle",{class:"path",cx:"33",cy:"33",r:"30","stroke-width":"4",stroke:"#70512a","stroke-dasharray":"50.26548245743669 50.26548245743669",fill:"none","stroke-linecap":"round"},null,-1),$e=[Ce],Ie=["textContent"];function xe(e,t,n,s,o,a){return l(),h(S,null,[(l(),h("svg",Te,$e)),p("div",{textContent:w(e.getText()),class:"loadingMessage"},null,8,Ie)],64)}const X=T(E,[["render",xe]]);var Pe=Object.defineProperty,Se=Object.getOwnPropertyDescriptor,U=(e,t,n,s)=>{for(var o=s>1?void 0:s?Se(t,n):t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=(s?i(t,n,o):i(o))||o);return s&&o&&Pe(t,n,o),o};let y=class extends k{constructor(){super(...arguments);r(this,"t",d);r(this,"birth",null);r(this,"id");r(this,"name")}goBirth(){M.push(`/profile/${this.id}`)}};U([j({required:!0})],y.prototype,"id",2);U([j({required:!0})],y.prototype,"name",2);y=U([_({components:{Icon:F}})],y);const qe={class:"textR"};function Be(e,t,n,s,o,a){const i=O("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...m)=>e.goBirth&&e.goBirth(...m))},[f(i,{class:"iconR",icon:"tabler:candy"}),p("span",qe,w(e.t.birthday.birthday.replace("{0}",e.name)),1)])}const Z=T(y,[["render",Be],["__scopeId","data-v-7151c5ba"]]);var ze=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let L=class extends k{constructor(){super(...arguments);r(this,"i18n",d);r(this,"people",null)}created(){J(I(q,"people-list.json")).then(t=>t.json()).then(t=>this.people=t)}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];M.push(`/profile/${t.id}`)}};L=ze([_({components:{Icon:F}})],L);const Ee={class:"textR"};function Le(e,t,n,s,o,a){const i=O("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...m)=>e.rand&&e.rand(...m))},[f(i,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",Ee,w(e.i18n.random),1)])}const ee=T(L,[["render",Le],["__scopeId","data-v-c84a467d"]]),Ae=`<h1 id="suicide-prevention">Suicide Prevention</h1>
...
`,He=`<p>我一直记得《寻梦环游记》里面一句话：死亡不是生命的终点，遗忘才是。那些离开了我们的人，或许正在某个地方对我们说：「请你们不要忘记我。」</p>
...
`,De=`<p>我一直記得《尋夢環遊記》裏面一句話：死亡不是生命的終點，遺忘纔是。那些離開了我們的人，或許正在某個地方對我們說：「請你們不要忘記我。」</p>
...
`,Ne=`<p>[!Note] &quot;2024 Transgender Day of Visibility Gala&quot; <a href="/profile/tdor">message collection text version</a> is now open for reading. Thank you for your messages.</p>
`,Re=`<p>[!Note] 『2024年 跨性別現身日晚會<a href="/profile/tdor">留言集文字版</a>現已開放閱讀，感謝大家的來信。</p>
`,Ve=`<p>[!Note] 『2024年 跨性别现身日晚会』<a href="/profile/tdor">来信集合文字版</a>已经开放阅读，感谢大家的来信。</p>
`,We=`<p><strong>As the first month of spring passes its halfway mark, March 31 marks another Transgender Day of Visibility.</strong></p>
...
<p>写一封来信：</p>
`,Fe=`<p><strong>轉眼三月過半。3月31日又是一度跨性別現身日。</strong></p>
...
<p>寫一封來信：</p>
`;function Je(e,t={}){if(e.hasAttribute("fit-initialized"))return;function n(){const s=t.width??e.parentElement.clientWidth;if(e.clientWidth<=s)return;const o=window.getComputedStyle(e);let a=s/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",t.maxFontSize&&(a=Math.min(a,t.maxFontSize)),t.minFontSize&&(a=Math.max(a,t.minFontSize)),e.style.fontSize=a+"px"}n(),e.addEventListener("resize",n),e.addEventListener("orientationchange",n),e.setAttribute("fit-initialized","y")}var Ge=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let A=class extends k{constructor(){super(...arguments);r(this,"textInputCache","");r(this,"textInputKey");r(this,"showCaptchaPrompt",!1);r(this,"t",d);r(this,"p",{id:"tdor"});r(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(n){this.showCaptchaPrompt=!1;const s={id:this.p.id,content:this.textInput,...n};B(s),C.fire({title:d.nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{C.showLoading(null),ae(se+"/comment/add",{method:"POST",params:s}).then(()=>{this.textInput="",C.fire({title:d.nav_success,text:d.nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:d.nav_ok_1,showCloseButton:!0})}).catch(o=>{ie(o),C.fire({title:d.nav_failed,text:d.nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(n){this.textInputCache=n,localStorage.setItem(this.textInputKey,n)}mounted(){this.resizeInput(),_e()}resizeInput(){const n=this.$refs.input;n.style.height="auto",n.style.height=`${n.scrollHeight+18}px`}};A=Ge([_({components:{MarkdownTooltip:Y,SubmitPrompt:Q}})],A);const Ke={id:"TdorComments",class:"introduction"},Ye={id:"add-comment"},Qe=["placeholder"],Xe={key:0,id:"send-comment-btn"},Ze={class:"char-count unselectable"};function et(e,t,n,s,o,a){const i=be,m=Y,x=Q;return l(),h("div",Ke,[f(G,{name:"collapse"},{default:z(()=>[D(p("div",Ye,[D(p("textarea",{id:"comment-textarea","onUpdate:modelValue":t[0]||(t[0]=g=>e.textInput=g),placeholder:e.t.nav_comment_placeholder,onInput:t[1]||(t[1]=(...g)=>e.resizeInput&&e.resizeInput(...g)),ref:"input"},null,40,Qe),[[re,e.textInput]]),e.textInput.length>0?(l(),h("div",Xe,[p("span",Ze,w(e.textInput.length)+" "+w(e.t.nav_comment_status),1),f(i,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):u("",!0),f(m,{"text-area-id":"comment-textarea"})],512),[[le,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(l(),v(x,{key:0,onSubmit:e.submitRequest,onClose:t[2]||(t[2]=g=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):u("",!0)])}const tt=T(A,[["render",et]]);var nt=Object.defineProperty,ot=Object.getOwnPropertyDescriptor,H=(e,t,n,s)=>{for(var o=s>1?void 0:s?ot(t,n):t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=(s?i(t,n,o):i(o))||o);return s&&o&&nt(t,n,o),o};let b=class extends k{constructor(){super(...arguments);r(this,"clicked","");r(this,"showAdd",!1);r(this,"isLoading",!0);r(this,"lang",P());r(this,"tdorTop",$(this.lang==="zh_hans"?je:this.lang==="zh_hant"?Fe:We));r(this,"tdorCommentView",$(this.lang==="zh_hans"?Ve:this.lang==="zh_hant"?Re:Ne));r(this,"htmlTop",$(this.lang==="zh_hans"?He:this.lang==="zh_hant"?De:Ue));r(this,"htmlBottom",$(this.lang==="zh_hans"?Me:this.lang==="zh_hant"?Oe:Ae));r(this,"people",null);r(this,"birthdayList",[]);r(this,"bookmarkTexts");r(this,"bookmark")}isDeadlinePassed(){return!0}isShowCommentsEntry(){return!1}updated(){if(this.bookmark!=null){const n=this.bookmark[0].offsetWidth-10;for(const s of this.bookmarkTexts)Je(s,{width:n})}}created(){B(`Language: ${this.lang}`),J(I(q,"people-home-list.json")).then(n=>n.text()).then(n=>{this.people=W()&&N()<.35?pe(JSON.parse(n)):JSON.parse(n);const s=new Date,o=s.getDate()==1&&s.getMonth()+1==4?.5:.05;W()&&N()<o&&he(1500,()=>{this.people=fe(this.people)})}),fetch(I(q,"birthday-list.json")).then(n=>n.json()).then(n=>{for(const s of n){const o=new Date(s[1]),a=new Date;if(o.getDate()==a.getDate()&&o.getMonth()==a.getMonth()){const i=JSON.parse(de(I(ce(s[0]),P()=="zh_hans"?"info.json":`info.${P()}.json`)));this.birthdayList.push([s[0],i.name])}}console.log(this.birthdayList),this.birthdayList.length&&ue()})}switchPage(n){B(`switchPage(${n.id})`),M.push(`/profile/${n.id}`)}profileUrl(n){return me(n.profileUrl,n.id)}};H([K()],b.prototype,"bookmarkTexts",2);H([K()],b.prototype,"bookmark",2);b=H([_({components:{TdorComments:tt,Loading:X,RandomPerson:ee,BirthdayButton:Z}})],b);const te=e=>(ve("data-v-1a061e74"),e=e(),ye(),e),at=["innerHTML"],st=["innerHTML"],it=["innerHTML"],rt={class:"randomButtons"},lt=te(()=>p("div",{class:"back"},null,-1)),pt=["href"],ht=["src","onClick"],dt={key:0,class:"profile"},ct=te(()=>p("div",{class:"back add fbox-vcenter"},"+",-1)),ut=[ct],mt=["innerHTML"];function ft(e,t,n,s,o,a){const i=O("TdorComments"),m=ee,x=Z,g=X;return l(),h("div",null,[p("div",{id:"home",class:we(e.clicked?"clicked":"")},[e.isShowCommentsEntry()?(l(),h("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorCommentView},null,8,at)):u("",!0),e.isDeadlinePassed()?u("",!0):(l(),h("div",{key:1,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,st)),e.isDeadlinePassed()?u("",!0):(l(),v(i,{key:2})),p("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,it),p("div",rt,[f(m,{class:"randomP"}),(l(!0),h(S,null,R(e.birthdayList,c=>(l(),v(x,{class:"randomP",key:c[0],id:c[0],name:c[1]},null,8,["id","name"]))),128))]),e.isLoading?(l(),v(g,{key:3})):u("",!0),e.people?(l(),v(ge,{key:4,id:"profiles",class:"unselectable",name:"profiles",tag:"div"},{default:z(()=>[(l(!0),h(S,null,R(e.people,c=>(l(),h("div",{class:"profile",key:c.id},[lt,p("a",{href:`/profile/${c.id}`,onClick:V(()=>!1,["exact","prevent","stop"])},[f(G,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:z(()=>[e.clicked!==c.name?(l(),h("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:V(()=>(e.clicked||(e.clicked=c.name),!1),["exact"]),onLoad:t[0]||(t[0]=gt=>e.isLoading=!1)},null,40,ht)):u("",!0)]),_:2},1032,["onAfterLeave"])],8,pt),p("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},w(c.name),513),p("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(l(),h("div",dt,ut)):u("",!0)]),_:1})):u("",!0),p("div",{class:"introduction markdown-content bottom",innerHTML:e.htmlBottom},null,8,mt)],2)])}const Ct=T(b,[["render",ft],["__scopeId","data-v-1a061e74"]]);export{Ct as default};
