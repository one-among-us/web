var N=Object.defineProperty;var W=(e,t,n)=>t in e?N(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var i=(e,t,n)=>(W(e,typeof t!="symbol"?t+"":t,n),n);import{O as I,V as P,g as h,i as u,a as b,u as A,d as z,_ as $,r as O,o as l,c as d,b as g,e as p,t as y,f as F,h as j,w as E,j as S,v as V,k as m,l as K,T as U,m as B,n as Y,F as G,p as J,q as X,s as q,x as Q,y as Z}from"./index-5362d75e.js";import{f as H,a as ee,h as T}from"./helper-5d281cb5.js";import{I as te,_ as M,a as ne,R as L}from"./paper-plane-12aba174.js";import{_ as D,S as _}from"./sweetalert2.all-da399f49.js";import{X as oe}from"./index-6be3cc35-f697ed0f.js";var ae=Object.defineProperty,se=Object.getOwnPropertyDescriptor,ie=(e,t,n,a)=>{for(var o=a>1?void 0:a?se(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&ae(t,n,o),o};let k=class extends P{constructor(){super(...arguments);i(this,"lang",h());i(this,"i18n",u[h()]);i(this,"people",null)}created(){b(`Language: ${this.lang}`),H(A(z,"people-list.json")).then(t=>t.json()).then(t=>this.people=t)}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];this.$router.push(`/profile/${t.id}`)}};k=ie([I({components:{Icon:te}})],k);const re={class:"textR"};function le(e,t,n,a,o,s){const r=O("Icon");return l(),d("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...w)=>e.rand&&e.rand(...w))},[g(r,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",re,y(e.i18n.random),1)])}const pe=$(k,[["render",le],["__scopeId","data-v-f5ab7655"]]),he=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
...
`,fe=`<p>I always remember a sentence in &quot;Coco&quot;: Death is not the end of life, but oblivion is. Those who have left us, perhaps somewhere, are whispering to us: &quot;Please don&#39;t forget me.&quot;    </p>
...
`;function _e(e,t={}){if(e.hasAttribute("fit-initialized"))return;function n(){const a=t.width??e.parentElement.clientWidth;if(e.clientWidth<=a)return;const o=window.getComputedStyle(e);let s=a/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",t.maxFontSize&&(s=Math.min(s,t.maxFontSize)),t.minFontSize&&(s=Math.max(s,t.minFontSize)),e.style.fontSize=s+"px"}n(),e.addEventListener("resize",n),e.addEventListener("orientationchange",n),e.setAttribute("fit-initialized","y")}var be=Object.defineProperty,ye=Object.getOwnPropertyDescriptor,Te=(e,t,n,a)=>{for(var o=a>1?void 0:a?ye(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&be(t,n,o),o};let C=class extends P{constructor(){super(...arguments);i(this,"textInputCache","");i(this,"textInputKey");i(this,"showCaptchaPrompt",!1);i(this,"i18n",u[h()]);i(this,"p",{id:"tdor"});i(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(n){this.showCaptchaPrompt=!1;const a={id:this.p.id,content:this.textInput,...n};b(a),_.fire({title:u[h()].nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{_.showLoading(null),ee(F+"/comment/add",{method:"POST",params:a}).then(()=>{this.textInput="",_.fire({title:u[h()].nav_success,text:u[h()].nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:u[h()].nav_ok_1,showCloseButton:!0})}).catch(o=>{j(o),_.fire({title:u[h()].nav_failed,text:u[h()].nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(n){this.textInputCache=n,localStorage.setItem(this.textInputKey,n)}mounted(){this.resizeInput(),oe()}resizeInput(){const n=this.$refs.input;n.style.height="auto",n.style.height=`${n.scrollHeight+18}px`}};C=Te([I({components:{MarkdownTooltip:M,SubmitPrompt:D}})],C);const ke={id:"TdorComments",class:"introduction"},Ce={id:"add-comment"},Ie=["placeholder"],Pe={key:0,id:"send-comment-btn"},$e={class:"char-count unselectable"};function xe(e,t,n,a,o,s){const r=ne,w=M,c=D;return l(),d("div",ke,[g(U,{name:"collapse"},{default:E(()=>[S(p("div",Ce,[S(p("textarea",{id:"comment-textarea","onUpdate:modelValue":t[0]||(t[0]=f=>e.textInput=f),placeholder:e.i18n.nav_comment_placeholder,onInput:t[1]||(t[1]=(...f)=>e.resizeInput&&e.resizeInput(...f)),ref:"input"},null,40,Ie),[[V,e.textInput]]),e.textInput.length>0?(l(),d("div",Pe,[p("span",$e,y(e.textInput.length)+" "+y(e.i18n.nav_comment_status),1),g(r,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):m("",!0),g(w,{"text-area-id":"comment-textarea"})],512),[[K,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(l(),B(c,{key:0,onSubmit:e.submitRequest,onClose:t[2]||(t[2]=f=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):m("",!0)])}const Se=$(C,[["render",xe]]);var qe=Object.defineProperty,Ae=Object.getOwnPropertyDescriptor,x=(e,t,n,a)=>{for(var o=a>1?void 0:a?Ae(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&qe(t,n,o),o};let v=class extends P{constructor(){super(...arguments);i(this,"clicked","");i(this,"showAdd",!1);i(this,"lang",h());i(this,"tdorTop",T(this.lang==="zh_hans"?he:this.lang==="zh_hant"?de:ce));i(this,"htmlTop",T(this.lang==="zh_hans"?ue:this.lang==="zh_hant"?me:fe));i(this,"htmlBottom",T(this.lang==="zh_hans"?ge:this.lang==="zh_hant"?we:ve));i(this,"people",null);i(this,"bookmarkTexts");i(this,"bookmark")}isDeadlinePassed(){const n=new Date(2024,2,27,16,0);return new Date>n}updated(){if(this.bookmark!=null){const n=this.bookmark[0].offsetWidth-10;for(const a of this.bookmarkTexts)_e(a,{width:n})}}created(){b(`Language: ${this.lang}`),H(A(z,"people-list.json")).then(n=>n.text()).then(n=>{this.people=JSON.parse(n)})}switchPage(n){b(`switchPage(${n.id})`),this.$router.push(`/profile/${n.id}`)}profileUrl(n){return Y(n.profileUrl,n.id)}};x([L()],v.prototype,"bookmarkTexts",2);x([L()],v.prototype,"bookmark",2);v=x([I({components:{TdorComments:Se}})],v);const R=e=>(Q("data-v-58e4849a"),e=e(),Z(),e),ze=["innerHTML"],Oe=["innerHTML"],Ee={key:2,id:"profiles",class:"unselectable"},Ue=R(()=>p("div",{class:"back"},null,-1)),Be=["href","onClick"],He=["src","onClick"],Me={key:0,class:"profile"},Le=R(()=>p("div",{class:"back add fbox-vcenter"},"+",-1)),De=[Le],Re=["innerHTML"];function Ne(e,t,n,a,o,s){const r=O("TdorComments"),w=pe;return l(),d("div",null,[p("div",{id:"home",class:X(e.clicked?"clicked":"")},[e.isDeadlinePassed()?m("",!0):(l(),d("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,ze)),e.isDeadlinePassed()?m("",!0):(l(),B(r,{key:1})),p("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,Oe),g(w),e.people?(l(),d("div",Ee,[(l(!0),d(G,null,J(e.people,(c,f)=>(l(),d("div",{class:"profile",key:f},[Ue,p("a",{href:`/profile/${c.id}`,onClick:q(()=>!1,["exact","prevent","stop"])},[g(U,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:E(()=>[e.clicked!==c.name?(l(),d("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:q(()=>(e.clicked||(e.clicked=c.name),!1),["exact"])},null,8,He)):m("",!0)]),_:2},1032,["onAfterLeave"])],8,Be),p("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},y(c.name),513),p("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(l(),d("div",Me,De)):m("",!0)])):m("",!0),p("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,Re)],2)])}const Xe=$(v,[["render",Ne],["__scopeId","data-v-58e4849a"]]);export{Xe as default};
