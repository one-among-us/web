var W=Object.defineProperty;var F=(e,t,n)=>t in e?W(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var s=(e,t,n)=>(F(e,typeof t!="symbol"?t+"":t,n),n);import{C,V as I,t as c,u as $,d as z,r as A,_ as S,a as E,o as l,c as h,b as f,e as p,f as y,i as _,g as R,h as D,w as U,j as q,v as j,k as u,l as G,T as H,m as B,n as J,p as K,q as M,F as Y,s as Q,x as X,y as x,z as Z,A as ee}from"./index-rljvhRs8.js";import{f as L,a as te,h as v}from"./helper-orh6ksOm.js";import{I as ne,_ as O,a as oe}from"./paper-plane-BZTKi4PY.js";import{_ as N,S as b}from"./sweetalert2.all-MotUEfAM.js";import{J as ae}from"./index-ab8010ff-UIJ15Xn5.js";var se=(e,t,n,i)=>{for(var o=t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=r(o)||o);return o};let k=class extends I{constructor(){super(...arguments);s(this,"i18n",c);s(this,"people",null)}created(){L($(z,"people-list.json")).then(t=>t.json()).then(t=>this.people=t)}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];A.push(`/profile/${t.id}`)}};k=se([C({components:{Icon:ne}})],k);const ie={class:"textR"};function re(e,t,n,i,o,a){const r=E("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...g)=>e.rand&&e.rand(...g))},[f(r,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",ie,y(e.i18n.random),1)])}const le=S(k,[["render",re],["__scopeId","data-v-4e3fc4bd"]]),pe=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
...
<p>写一封来信：</p>
`,he=`<p><strong>轉眼三月過半。3月31日又是一度跨性別現身日。</strong></p>
...
<p>寫一封來信：</p>
`,de=`<p><strong>As the first month of spring passes its halfway mark, March 31 marks another Transgender Day of Visibility.</strong></p>
...
<p>Write a letter:</p>
`,ce=`<p>[!Note] 『2024年 跨性别现身日晚会』<a href="/profile/tdor">来信集合文字版</a>已经开放阅读，感谢大家的来信。</p>
`,ue=`<p>[!Note] &quot;2024 Transgender Day of Visibility Gala&quot; <a href="/profile/tdor">message collection text version</a> is now open for reading. Thank you for your messages.</p>
`,me=`<p>[!Note] 『2024年 跨性別現身日晚會<a href="/profile/tdor">留言集文字版</a>現已開放閱讀，感謝大家的來信。</p>
`,fe=`<p>我一直记得《寻梦环游记》里面一句话：死亡不是生命的终点，遗忘才是。那些离开了我们的人，或许正在某个地方对我们说：「请你们不要忘记我。」</p>
...
`,ge=`<p>我一直記得《尋夢環遊記》裏面一句話：死亡不是生命的終點，遺忘纔是。那些離開了我們的人，或許正在某個地方對我們說：「請你們不要忘記我。」</p>
...
`,we=`<p>I always remember a sentence in &quot;Coco&quot;: Death is not the end of life, but oblivion is. Those who have left us, perhaps somewhere, are whispering to us: &quot;Please don&#39;t forget me.&quot;    </p>
...
`;function _e(e,t={}){if(e.hasAttribute("fit-initialized"))return;function n(){const i=t.width??e.parentElement.clientWidth;if(e.clientWidth<=i)return;const o=window.getComputedStyle(e);let a=i/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",t.maxFontSize&&(a=Math.min(a,t.maxFontSize)),t.minFontSize&&(a=Math.max(a,t.minFontSize)),e.style.fontSize=a+"px"}n(),e.addEventListener("resize",n),e.addEventListener("orientationchange",n),e.setAttribute("fit-initialized","y")}var ke=(e,t,n,i)=>{for(var o=t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=r(o)||o);return o};let T=class extends I{constructor(){super(...arguments);s(this,"textInputCache","");s(this,"textInputKey");s(this,"showCaptchaPrompt",!1);s(this,"t",c);s(this,"p",{id:"tdor"});s(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(n){this.showCaptchaPrompt=!1;const i={id:this.p.id,content:this.textInput,...n};_(i),b.fire({title:c.nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{b.showLoading(null),te(R+"/comment/add",{method:"POST",params:i}).then(()=>{this.textInput="",b.fire({title:c.nav_success,text:c.nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:c.nav_ok_1,showCloseButton:!0})}).catch(o=>{D(o),b.fire({title:c.nav_failed,text:c.nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(n){this.textInputCache=n,localStorage.setItem(this.textInputKey,n)}mounted(){this.resizeInput(),ae()}resizeInput(){const n=this.$refs.input;n.style.height="auto",n.style.height=`${n.scrollHeight+18}px`}};T=ke([C({components:{MarkdownTooltip:O,SubmitPrompt:N}})],T);const Te={id:"TdorComments",class:"introduction"},Ce={id:"add-comment"},Ie=["placeholder"],Se={key:0,id:"send-comment-btn"},Pe={class:"char-count unselectable"};function qe(e,t,n,i,o,a){const r=oe,g=O,d=N;return l(),h("div",Te,[f(H,{name:"collapse"},{default:U(()=>[q(p("div",Ce,[q(p("textarea",{id:"comment-textarea","onUpdate:modelValue":t[0]||(t[0]=m=>e.textInput=m),placeholder:e.t.nav_comment_placeholder,onInput:t[1]||(t[1]=(...m)=>e.resizeInput&&e.resizeInput(...m)),ref:"input"},null,40,Ie),[[j,e.textInput]]),e.textInput.length>0?(l(),h("div",Se,[p("span",Pe,y(e.textInput.length)+" "+y(e.t.nav_comment_status),1),f(r,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):u("",!0),f(g,{"text-area-id":"comment-textarea"})],512),[[G,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(l(),B(d,{key:0,onSubmit:e.submitRequest,onClose:t[2]||(t[2]=m=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):u("",!0)])}const xe=S(T,[["render",qe]]);var $e=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,P=(e,t,n,i)=>{for(var o=i>1?void 0:i?ze(t,n):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(i?r(t,n,o):r(o))||o);return i&&o&&$e(t,n,o),o};let w=class extends I{constructor(){super(...arguments);s(this,"clicked","");s(this,"showAdd",!1);s(this,"lang",J());s(this,"tdorTop",v(this.lang==="zh_hans"?pe:this.lang==="zh_hant"?he:de));s(this,"tdorCommentView",v(this.lang==="zh_hans"?ce:this.lang==="zh_hant"?me:ue));s(this,"htmlTop",v(this.lang==="zh_hans"?fe:this.lang==="zh_hant"?ge:we));s(this,"htmlBottom",v(this.lang==="zh_hans"?ve:this.lang==="zh_hant"?be:ye));s(this,"people",null);s(this,"bookmarkTexts");s(this,"bookmark")}isDeadlinePassed(){return!0}isShowCommentsEntry(){return!1}updated(){if(this.bookmark!=null){const n=this.bookmark[0].offsetWidth-10;for(const i of this.bookmarkTexts)_e(i,{width:n})}}created(){_(`Language: ${this.lang}`),L($(z,"people-home-list.json")).then(n=>n.text()).then(n=>this.people=JSON.parse(n))}switchPage(n){_(`switchPage(${n.id})`),A.push(`/profile/${n.id}`)}profileUrl(n){return K(n.profileUrl,n.id)}};P([M()],w.prototype,"bookmarkTexts",2);P([M()],w.prototype,"bookmark",2);w=P([C({components:{TdorComments:xe}})],w);const V=e=>(Z("data-v-acfe7f66"),e=e(),ee(),e),Ae=["innerHTML"],Ee=["innerHTML"],Ue=["innerHTML"],He={key:3,id:"profiles",class:"unselectable"},Be=V(()=>p("div",{class:"back"},null,-1)),Me=["href"],Le=["src","onClick"],Oe={key:0,class:"profile"},Ne=V(()=>p("div",{class:"back add fbox-vcenter"},"+",-1)),Ve=[Ne],We=["innerHTML"];function Fe(e,t,n,i,o,a){const r=E("TdorComments"),g=le;return l(),h("div",null,[p("div",{id:"home",class:X(e.clicked?"clicked":"")},[e.isShowCommentsEntry()?(l(),h("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorCommentView},null,8,Ae)):u("",!0),e.isDeadlinePassed()?u("",!0):(l(),h("div",{key:1,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,Ee)),e.isDeadlinePassed()?u("",!0):(l(),B(r,{key:2})),p("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,Ue),f(g),e.people?(l(),h("div",He,[(l(!0),h(Y,null,Q(e.people,(d,m)=>(l(),h("div",{class:"profile",key:m},[Be,p("a",{href:`/profile/${d.id}`,onClick:x(()=>!1,["exact","prevent","stop"])},[f(H,{name:"fade",onAfterLeave:()=>e.switchPage(d)},{default:U(()=>[e.clicked!==d.name?(l(),h("img",{key:0,src:e.profileUrl(d),draggable:"false",alt:"profile",class:"front clickable",onClick:x(()=>(e.clicked||(e.clicked=d.name),!1),["exact"])},null,8,Le)):u("",!0)]),_:2},1032,["onAfterLeave"])],8,Me),p("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},y(d.name),513),p("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(l(),h("div",Oe,Ve)):u("",!0)])):u("",!0),p("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,We)],2)])}const Xe=S(w,[["render",Fe],["__scopeId","data-v-acfe7f66"]]);export{Xe as default};
