var te=Object.defineProperty;var ne=(e,t,n)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var r=(e,t,n)=>(ne(e,typeof t!="symbol"?t+"":t,n),n);import{C as b,V as _,t as d,_ as k,o as l,c as h,a as p,b as w,F as S,d as R,r as L,I as V,e as M,f,u as $,g as q,i as B,S as T,h as oe,j as ae,w as W,k as H,v as se,l as u,m as ie,T as j,n as I,p as P,q as re,s as le,x as pe,y as F,z as N,A as he,B as D,D as de,E as ce}from"./index-DXqtw-CK.js";import{f as J,a as ue,h as C,g as me,s as fe,b as ge}from"./helper-DKXhlQJt.js";import{_ as Y,a as we,i as ve}from"./paper-plane-DC9ZuDqq.js";import{_ as G}from"./SubmitPrompt-Bb5WYZu8.js";import{J as ye}from"./index-ab8010ff-Aq4PyHzL.js";var be=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let z=class extends _{getText(){return localStorage.getItem("easterEggMode")?parseInt(localStorage.getItem("easterEggMode"))==0?d.loading.loading:d.loading.easter[Math.random()*d.loading.easter.length|0]:d.loading.loading}};z=be([b({})],z);const _e={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",style:{margin:"auto",background:"transparent",display:"block"},width:"150px",height:"150px",viewBox:"0 0 66 66",preserveAspectRatio:"xMidYMid",class:"rotating"},ke=p("circle",{class:"path",cx:"33",cy:"33",r:"30","stroke-width":"4",stroke:"#70512a","stroke-dasharray":"50.26548245743669 50.26548245743669",fill:"none","stroke-linecap":"round"},null,-1),Te=[ke],Ce=["textContent"];function $e(e,t,n,s,o,a){return l(),h(S,null,[(l(),h("svg",_e,Te)),p("div",{textContent:w(e.getText()),class:"loadingMessage"},null,8,Ce)],64)}const K=k(z,[["render",$e]]);var Ie=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,O=(e,t,n,s)=>{for(var o=s>1?void 0:s?xe(t,n):t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=(s?i(t,n,o):i(o))||o);return s&&o&&Ie(t,n,o),o};let v=class extends _{constructor(){super(...arguments);r(this,"t",d);r(this,"birth",null);r(this,"id");r(this,"name")}goBirth(){L.push(`/profile/${this.id}`)}};O([R({required:!0})],v.prototype,"id",2);O([R({required:!0})],v.prototype,"name",2);v=O([b({components:{Icon:V}})],v);const Pe={class:"textR"};function Se(e,t,n,s,o,a){const i=M("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...m)=>e.goBirth&&e.goBirth(...m))},[f(i,{class:"iconR",icon:"tabler:candy"}),p("span",Pe,w(e.t.birthday.birthday.replace("{0}",e.name)),1)])}const Q=k(v,[["render",Se],["__scopeId","data-v-831bc504"]]);var qe=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let E=class extends _{constructor(){super(...arguments);r(this,"i18n",d);r(this,"people",null)}created(){J($(q,"people-list.json")).then(t=>t.json()).then(t=>this.people=t)}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];L.push(`/profile/${t.id}`)}};E=qe([b({components:{Icon:V}})],E);const Be={class:"textR"};function ze(e,t,n,s,o,a){const i=M("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...m)=>e.rand&&e.rand(...m))},[f(i,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",Be,w(e.i18n.random),1)])}const X=k(E,[["render",ze],["__scopeId","data-v-c84a467d"]]),Ee=`<h1 id="suicide-prevention">Suicide Prevention</h1>
...
`,Me=`<p>I always remember a sentence in &quot;Coco&quot;: Death is not the end of life, but oblivion is. Those who have left us, perhaps somewhere, are whispering to us: &quot;Please don&#39;t forget me.&quot;    </p>
...
`,Ue=`<p>我一直記得《尋夢環遊記》裏面一句話：死亡不是生命的終點，遺忘纔是。那些離開了我們的人，或許正在某個地方對我們說：「請你們不要忘記我。」</p>
...
`,He=`<p>[!Note] &quot;2024 Transgender Day of Visibility Gala&quot; <a href="/profile/tdor">message collection text version</a> is now open for reading. Thank you for your messages.</p>
`,Ne=`<p>[!Note] 『2024年 跨性別現身日晚會<a href="/profile/tdor">留言集文字版</a>現已開放閱讀，感謝大家的來信。</p>
`,De=`<p>[!Note] 『2024年 跨性别现身日晚会』<a href="/profile/tdor">来信集合文字版</a>已经开放阅读，感谢大家的来信。</p>
`,Re=`<p><strong>As the first month of spring passes its halfway mark, March 31 marks another Transgender Day of Visibility.</strong></p>
...
<p>Write a letter:</p>
`,Ve=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
...
<p>写一封来信：</p>
`,We=`<p><strong>轉眼三月過半。3月31日又是一度跨性別現身日。</strong></p>
...
<p>寫一封來信：</p>
`;function je(e,t={}){if(e.hasAttribute("fit-initialized"))return;function n(){const s=t.width??e.parentElement.clientWidth;if(e.clientWidth<=s)return;const o=window.getComputedStyle(e);let a=s/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",t.maxFontSize&&(a=Math.min(a,t.maxFontSize)),t.minFontSize&&(a=Math.max(a,t.minFontSize)),e.style.fontSize=a+"px"}n(),e.addEventListener("resize",n),e.addEventListener("orientationchange",n),e.setAttribute("fit-initialized","y")}var Fe=(e,t,n,s)=>{for(var o=t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=i(o)||o);return o};let A=class extends _{constructor(){super(...arguments);r(this,"textInputCache","");r(this,"textInputKey");r(this,"showCaptchaPrompt",!1);r(this,"t",d);r(this,"p",{id:"tdor"});r(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(n){this.showCaptchaPrompt=!1;const s={id:this.p.id,content:this.textInput,...n};B(s),T.fire({title:d.nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{T.showLoading(null),ue(oe+"/comment/add",{method:"POST",params:s}).then(()=>{this.textInput="",T.fire({title:d.nav_success,text:d.nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:d.nav_ok_1,showCloseButton:!0})}).catch(o=>{ae(o),T.fire({title:d.nav_failed,text:d.nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(n){this.textInputCache=n,localStorage.setItem(this.textInputKey,n)}mounted(){this.resizeInput(),ye()}resizeInput(){const n=this.$refs.input;n.style.height="auto",n.style.height=`${n.scrollHeight+18}px`}};A=Fe([b({components:{MarkdownTooltip:Y,SubmitPrompt:G}})],A);const Je={id:"TdorComments",class:"introduction"},Ye={id:"add-comment"},Ge=["placeholder"],Ke={key:0,id:"send-comment-btn"},Qe={class:"char-count unselectable"};function Xe(e,t,n,s,o,a){const i=we,m=Y,x=G;return l(),h("div",Je,[f(j,{name:"collapse"},{default:W(()=>[H(p("div",Ye,[H(p("textarea",{id:"comment-textarea","onUpdate:modelValue":t[0]||(t[0]=g=>e.textInput=g),placeholder:e.t.nav_comment_placeholder,onInput:t[1]||(t[1]=(...g)=>e.resizeInput&&e.resizeInput(...g)),ref:"input"},null,40,Ge),[[se,e.textInput]]),e.textInput.length>0?(l(),h("div",Ke,[p("span",Qe,w(e.textInput.length)+" "+w(e.t.nav_comment_status),1),f(i,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):u("",!0),f(m,{"text-area-id":"comment-textarea"})],512),[[ie,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(l(),I(x,{key:0,onSubmit:e.submitRequest,onClose:t[2]||(t[2]=g=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):u("",!0)])}const Ze=k(A,[["render",Xe]]);var et=Object.defineProperty,tt=Object.getOwnPropertyDescriptor,U=(e,t,n,s)=>{for(var o=s>1?void 0:s?tt(t,n):t,a=e.length-1,i;a>=0;a--)(i=e[a])&&(o=(s?i(t,n,o):i(o))||o);return s&&o&&et(t,n,o),o};let y=class extends _{constructor(){super(...arguments);r(this,"clicked","");r(this,"showAdd",!1);r(this,"isLoading",!0);r(this,"lang",P());r(this,"tdorTop",C(this.lang==="zh_hans"?Ve:this.lang==="zh_hant"?We:Re));r(this,"tdorCommentView",C(this.lang==="zh_hans"?De:this.lang==="zh_hant"?Ne:He));r(this,"htmlTop",C(this.lang==="zh_hans"?Oe:this.lang==="zh_hant"?Ue:Me));r(this,"htmlBottom",C(this.lang==="zh_hans"?Ae:this.lang==="zh_hant"?Le:Ee));r(this,"people",null);r(this,"birthdayList",[]);r(this,"bookmarkTexts");r(this,"bookmark")}isDeadlinePassed(){return!0}isShowCommentsEntry(){return!1}updated(){if(this.bookmark!=null){const n=this.bookmark[0].offsetWidth-10;for(const s of this.bookmarkTexts)je(s,{width:n})}}created(){B(`Language: ${this.lang}`),J($(q,"people-home-list.json")).then(n=>n.text()).then(n=>this.people=ve()&&me()<.4?fe(JSON.parse(n)):JSON.parse(n)),fetch($(q,"birthday-list.json")).then(n=>n.json()).then(n=>{for(const s of n){const o=new Date(s[1]),a=new Date;if(o.getDate()==a.getDate()&&o.getMonth()==a.getMonth()){const i=JSON.parse(ge($(re(s[0]),P()=="zh_hans"?"info.json":`info.${P()}.json`)));this.birthdayList.push([s[0],i.name])}}console.log(this.birthdayList),this.birthdayList.length&&le()})}switchPage(n){B(`switchPage(${n.id})`),L.push(`/profile/${n.id}`)}profileUrl(n){return pe(n.profileUrl,n.id)}};U([F()],y.prototype,"bookmarkTexts",2);U([F()],y.prototype,"bookmark",2);y=U([b({components:{TdorComments:Ze,Loading:K,RandomPerson:X,BirthdayButton:Q}})],y);const Z=e=>(de("data-v-a886fb50"),e=e(),ce(),e),nt=["innerHTML"],ot=["innerHTML"],at=["innerHTML"],st={class:"randomButtons"},it={key:4,id:"profiles",class:"unselectable"},rt=Z(()=>p("div",{class:"back"},null,-1)),lt=["href"],pt=["src","onClick"],ht={key:0,class:"profile"},dt=Z(()=>p("div",{class:"back add fbox-vcenter"},"+",-1)),ct=[dt],ut=["innerHTML"];function mt(e,t,n,s,o,a){const i=M("TdorComments"),m=X,x=Q,g=K;return l(),h("div",null,[p("div",{id:"home",class:he(e.clicked?"clicked":"")},[e.isShowCommentsEntry()?(l(),h("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorCommentView},null,8,nt)):u("",!0),e.isDeadlinePassed()?u("",!0):(l(),h("div",{key:1,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,ot)),e.isDeadlinePassed()?u("",!0):(l(),I(i,{key:2})),p("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,at),p("div",st,[f(m,{class:"randomP"}),(l(!0),h(S,null,N(e.birthdayList,c=>(l(),I(x,{class:"randomP",key:c[0],id:c[0],name:c[1]},null,8,["id","name"]))),128))]),e.isLoading?(l(),I(g,{key:3})):u("",!0),e.people?(l(),h("div",it,[(l(!0),h(S,null,N(e.people,(c,ee)=>(l(),h("div",{class:"profile",key:ee},[rt,p("a",{href:`/profile/${c.id}`,onClick:D(()=>!1,["exact","prevent","stop"])},[f(j,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:W(()=>[e.clicked!==c.name?(l(),h("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:D(()=>(e.clicked||(e.clicked=c.name),!1),["exact"]),onLoad:t[0]||(t[0]=ft=>e.isLoading=!1)},null,40,pt)):u("",!0)]),_:2},1032,["onAfterLeave"])],8,lt),p("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},w(c.name),513),p("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(l(),h("div",ht,ct)):u("",!0)])):u("",!0),p("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,ut)],2)])}const Ct=k(y,[["render",mt],["__scopeId","data-v-a886fb50"]]);export{Ct as default};
