var j=Object.defineProperty;var Y=(e,t,n)=>t in e?j(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var s=(e,t,n)=>(Y(e,typeof t!="symbol"?t+"":t,n),n);import{C as b,V as _,t as d,_ as k,o as l,c as h,a as p,b as g,F as A,u as E,d as M,r as L,e as U,f as m,i as C,S as v,g as G,h as J,w as B,j as q,v as K,k as u,l as Q,T as H,m as I,n as X,p as Z,q as O,s as ee,x as te,y as z,z as ne,A as oe}from"./index-BAwJ4AnI.js";import{f as N,a as ae,h as y}from"./helper-C4dGxUy3.js";import{I as se,_ as R,a as ie}from"./paper-plane-YnkVe_Ee.js";import{_ as V}from"./SubmitPrompt-BeT58a3u.js";import{J as re}from"./index-ab8010ff-CfOeECm_.js";var le=(e,t,n,i)=>{for(var o=t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=r(o)||o);return o};let x=class extends _{getText(){return localStorage.getItem("easterEggMode")?parseInt(localStorage.getItem("easterEggMode"))==0?d.loading.loading:d.loading.easter[Math.random()*d.loading.easter.length|0]:d.loading.loading}};x=le([b({})],x);const pe={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",style:{margin:"auto",background:"transparent",display:"block"},width:"150px",height:"150px",viewBox:"0 0 66 66",preserveAspectRatio:"xMidYMid",class:"rotating"},he=p("circle",{class:"path",cx:"33",cy:"33",r:"30","stroke-width":"4",stroke:"#70512a","stroke-dasharray":"50.26548245743669 50.26548245743669",fill:"none","stroke-linecap":"round"},null,-1),de=[he],ce=["textContent"];function ue(e,t,n,i,o,a){return l(),h(A,null,[(l(),h("svg",pe,de)),p("div",{textContent:g(e.getText()),class:"loadingMessage"},null,8,ce)],64)}const W=k(x,[["render",ue]]);var me=(e,t,n,i)=>{for(var o=t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=r(o)||o);return o};let $=class extends _{constructor(){super(...arguments);s(this,"i18n",d);s(this,"people",null)}created(){N(E(M,"people-list.json")).then(t=>t.json()).then(t=>this.people=t)}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];L.push(`/profile/${t.id}`)}};$=me([b({components:{Icon:se}})],$);const fe={class:"textR"};function ge(e,t,n,i,o,a){const r=U("Icon");return l(),h("button",{class:"random clickable hy-button",onClick:t[0]||(t[0]=(...f)=>e.rand&&e.rand(...f))},[m(r,{class:"iconR",icon:"lets-icons:sort-random-light"}),p("span",fe,g(e.i18n.random),1)])}const we=k($,[["render",ge],["__scopeId","data-v-4e3fc4bd"]]),ve=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
...
<p>写一封来信：</p>
`,ye=`<p><strong>轉眼三月過半。3月31日又是一度跨性別現身日。</strong></p>
...
<p>Write a letter:</p>
`,_e=`<p>[!Note] 『2024年 跨性别现身日晚会』<a href="/profile/tdor">来信集合文字版</a>已经开放阅读，感谢大家的来信。</p>
`,ke=`<p>[!Note] &quot;2024 Transgender Day of Visibility Gala&quot; <a href="/profile/tdor">message collection text version</a> is now open for reading. Thank you for your messages.</p>
`,Te=`<p>[!Note] 『2024年 跨性別現身日晚會<a href="/profile/tdor">留言集文字版</a>現已開放閱讀，感謝大家的來信。</p>
`,Ce=`<p>我一直记得《寻梦环游记》里面一句话：死亡不是生命的终点，遗忘才是。那些离开了我们的人，或许正在某个地方对我们说：「请你们不要忘记我。」</p>
...
`,Ie=`<p>我一直記得《尋夢環遊記》裏面一句話：死亡不是生命的終點，遺忘纔是。那些離開了我們的人，或許正在某個地方對我們說：「請你們不要忘記我。」</p>
...
`,xe=`<p>I always remember a sentence in &quot;Coco&quot;: Death is not the end of life, but oblivion is. Those who have left us, perhaps somewhere, are whispering to us: &quot;Please don&#39;t forget me.&quot;    </p>
...
`,Pe=`<h1 id="suicide-prevention">Suicide Prevention</h1>
...
`;function qe(e,t={}){if(e.hasAttribute("fit-initialized"))return;function n(){const i=t.width??e.parentElement.clientWidth;if(e.clientWidth<=i)return;const o=window.getComputedStyle(e);let a=i/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",t.maxFontSize&&(a=Math.min(a,t.maxFontSize)),t.minFontSize&&(a=Math.max(a,t.minFontSize)),e.style.fontSize=a+"px"}n(),e.addEventListener("resize",n),e.addEventListener("orientationchange",n),e.setAttribute("fit-initialized","y")}var ze=(e,t,n,i)=>{for(var o=t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=r(o)||o);return o};let S=class extends _{constructor(){super(...arguments);s(this,"textInputCache","");s(this,"textInputKey");s(this,"showCaptchaPrompt",!1);s(this,"t",d);s(this,"p",{id:"tdor"});s(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(n){this.showCaptchaPrompt=!1;const i={id:this.p.id,content:this.textInput,...n};C(i),v.fire({title:d.nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{v.showLoading(null),ae(G+"/comment/add",{method:"POST",params:i}).then(()=>{this.textInput="",v.fire({title:d.nav_success,text:d.nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:d.nav_ok_1,showCloseButton:!0})}).catch(o=>{J(o),v.fire({title:d.nav_failed,text:d.nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(n){this.textInputCache=n,localStorage.setItem(this.textInputKey,n)}mounted(){this.resizeInput(),re()}resizeInput(){const n=this.$refs.input;n.style.height="auto",n.style.height=`${n.scrollHeight+18}px`}};S=ze([b({components:{MarkdownTooltip:R,SubmitPrompt:V}})],S);const Ae={id:"TdorComments",class:"introduction"},Ee={id:"add-comment"},Me=["placeholder"],Le={key:0,id:"send-comment-btn"},Ue={class:"char-count unselectable"};function Be(e,t,n,i,o,a){const r=ie,f=R,T=V;return l(),h("div",Ae,[m(H,{name:"collapse"},{default:B(()=>[q(p("div",Ee,[q(p("textarea",{id:"comment-textarea","onUpdate:modelValue":t[0]||(t[0]=c=>e.textInput=c),placeholder:e.t.nav_comment_placeholder,onInput:t[1]||(t[1]=(...c)=>e.resizeInput&&e.resizeInput(...c)),ref:"input"},null,40,Me),[[K,e.textInput]]),e.textInput.length>0?(l(),h("div",Le,[p("span",Ue,g(e.textInput.length)+" "+g(e.t.nav_comment_status),1),m(r,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):u("",!0),m(f,{"text-area-id":"comment-textarea"})],512),[[Q,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(l(),I(T,{key:0,onSubmit:e.submitRequest,onClose:t[2]||(t[2]=c=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):u("",!0)])}const He=k(S,[["render",Be]]);var Oe=Object.defineProperty,Ne=Object.getOwnPropertyDescriptor,P=(e,t,n,i)=>{for(var o=i>1?void 0:i?Ne(t,n):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(i?r(t,n,o):r(o))||o);return i&&o&&Oe(t,n,o),o};let w=class extends _{constructor(){super(...arguments);s(this,"clicked","");s(this,"showAdd",!1);s(this,"isLoading",!0);s(this,"lang",X());s(this,"tdorTop",y(this.lang==="zh_hans"?ve:this.lang==="zh_hant"?ye:be));s(this,"tdorCommentView",y(this.lang==="zh_hans"?_e:this.lang==="zh_hant"?Te:ke));s(this,"htmlTop",y(this.lang==="zh_hans"?Ce:this.lang==="zh_hant"?Ie:xe));s(this,"htmlBottom",y(this.lang==="zh_hans"?$e:this.lang==="zh_hant"?Se:Pe));s(this,"people",null);s(this,"bookmarkTexts");s(this,"bookmark")}isDeadlinePassed(){return!0}isShowCommentsEntry(){return!1}updated(){if(this.bookmark!=null){const n=this.bookmark[0].offsetWidth-10;for(const i of this.bookmarkTexts)qe(i,{width:n})}}created(){C(`Language: ${this.lang}`),N(E(M,"people-home-list.json")).then(n=>n.text()).then(n=>this.people=JSON.parse(n))}switchPage(n){C(`switchPage(${n.id})`),L.push(`/profile/${n.id}`)}profileUrl(n){return Z(n.profileUrl,n.id)}};P([O()],w.prototype,"bookmarkTexts",2);P([O()],w.prototype,"bookmark",2);w=P([b({components:{TdorComments:He,Loading:W}})],w);const F=e=>(ne("data-v-daed718c"),e=e(),oe(),e),Re=["innerHTML"],Ve=["innerHTML"],We=["innerHTML"],Fe={key:4,id:"profiles",class:"unselectable"},De=F(()=>p("div",{class:"back"},null,-1)),je=["href"],Ye=["src","onClick"],Ge={key:0,class:"profile"},Je=F(()=>p("div",{class:"back add fbox-vcenter"},"+",-1)),Ke=[Je],Qe=["innerHTML"];function Xe(e,t,n,i,o,a){const r=U("TdorComments"),f=we,T=W;return l(),h("div",null,[p("div",{id:"home",class:te(e.clicked?"clicked":"")},[e.isShowCommentsEntry()?(l(),h("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorCommentView},null,8,Re)):u("",!0),e.isDeadlinePassed()?u("",!0):(l(),h("div",{key:1,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,Ve)),e.isDeadlinePassed()?u("",!0):(l(),I(r,{key:2})),p("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,We),m(f),e.isLoading?(l(),I(T,{key:3})):u("",!0),e.people?(l(),h("div",Fe,[(l(!0),h(A,null,ee(e.people,(c,D)=>(l(),h("div",{class:"profile",key:D},[De,p("a",{href:`/profile/${c.id}`,onClick:z(()=>!1,["exact","prevent","stop"])},[m(H,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:B(()=>[e.clicked!==c.name?(l(),h("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:z(()=>(e.clicked||(e.clicked=c.name),!1),["exact"]),onLoad:t[0]||(t[0]=Ze=>e.isLoading=!1)},null,40,Ye)):u("",!0)]),_:2},1032,["onAfterLeave"])],8,je),p("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},g(c.name),513),p("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(l(),h("div",Ge,Ke)):u("",!0)])):u("",!0),p("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,Qe)],2)])}const lt=k(w,[["render",Xe],["__scopeId","data-v-daed718c"]]);export{lt as default};
