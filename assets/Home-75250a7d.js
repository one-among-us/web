var N=Object.defineProperty;var W=(e,t,n)=>t in e?N(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var i=(e,t,n)=>(W(e,typeof t!="symbol"?t+"":t,n),n);import{O as P,V as $,g as h,i as u,a as _,u as A,d as z,_ as I,o as p,c as d,b as l,t as b,p as O,e as E,f as j,h as V,j as g,w as U,k as S,v as K,l as m,m as Y,T as B,n as H,r as G,q as J,F as X,s as Q,x as Z,y as q}from"./index-5a380a92.js";import{f as M,a as ee,h as T}from"./helper-a2fea4ce.js";import{_ as L,a as te,R as D}from"./paper-plane-8e4e7f92.js";import{_ as R,S as v}from"./sweetalert2.all-f51283ef.js";import{X as ne}from"./index-6be3cc35-6c4e0d8a.js";var oe=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,se=(e,t,n,a)=>{for(var o=a>1?void 0:a?ae(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&oe(t,n,o),o};let k=class extends ${constructor(){super(...arguments);i(this,"lang",h());i(this,"i18n",u[h()]);i(this,"people",null)}created(){_(`Language: ${this.lang}`),M(A(z,"people-list.json")).then(t=>t.json()).then(t=>{this.people=t})}rand(){if(!this.people)return;const t=this.people[Math.floor(this.people.length*Math.random())];this.$router.push(`/profile/${t.id}`)}};k=se([P({components:{}})],k);const ie=e=>(O("data-v-1d118252"),e=e(),E(),e),re=ie(()=>l("div",{class:"iconR"},"🔀",-1)),le={class:"textR"};function pe(e,t,n,a,o,s){return p(),d("button",{class:"random shadow",onClick:t[0]||(t[0]=(...r)=>e.rand&&e.rand(...r))},[re,l("div",le,b(e.i18n.random),1)])}const he=I(k,[["render",pe],["__scopeId","data-v-1d118252"]]),de=`<p><strong>转眼三月过半。3月31日又是一度跨性别现身日。</strong></p>
...
<p>写一封来信：</p>
`,ce=`<p><strong>轉眼三月過半。3月31日又是一度跨性別現身日。</strong></p>
...
<p>寫一封來信：</p>
`,ue=`<p><strong>As the first month of spring passes its halfway mark, March 31 marks another Transgender Day of Visibility.</strong></p>
...
<p>Write a letter:</p>
`,me=`<p>我一直记得《寻梦环游记》里面一句话：死亡不是生命的终点，遗忘才是。那些离开了我们的人，或许正在某个地方对我们说：「请你们不要忘记我。」</p>
...
`,fe=`<p>我一直記得《尋夢環遊記》裏面一句話：死亡不是生命的終點，遺忘纔是。那些離開了我們的人，或許正在某個地方對我們說：「請你們不要忘記我。」</p>
...
`,ge=`<p>I always remember a sentence in &quot;Coco&quot;: Death is not the end of life, but oblivion is. Those who have left us, perhaps somewhere, are whispering to us: &quot;Please don&#39;t forget me.&quot;    </p>
...
`,_e=`<h1 id="suicide-prevention">Suicide Prevention</h1>
...
`;function be(e,t={}){if(e.hasAttribute("fit-initialized"))return;function n(){const a=t.width??e.parentElement.clientWidth;if(e.clientWidth<=a)return;const o=window.getComputedStyle(e);let s=a/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",t.maxFontSize&&(s=Math.min(s,t.maxFontSize)),t.minFontSize&&(s=Math.max(s,t.minFontSize)),e.style.fontSize=s+"px"}n(),e.addEventListener("resize",n),e.addEventListener("orientationchange",n),e.setAttribute("fit-initialized","y")}var ye=Object.defineProperty,Te=Object.getOwnPropertyDescriptor,ke=(e,t,n,a)=>{for(var o=a>1?void 0:a?Te(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&ye(t,n,o),o};let C=class extends ${constructor(){super(...arguments);i(this,"textInputCache","");i(this,"textInputKey");i(this,"showCaptchaPrompt",!1);i(this,"i18n",u[h()]);i(this,"p",{id:"tdor"});i(this,"showInputArea",!0)}btnSend(){this.showCaptchaPrompt=!0}alterTextArea(){this.showInputArea=!this.showInputArea}submitRequest(n){this.showCaptchaPrompt=!1;const a={id:this.p.id,content:this.textInput,...n};_(a),v.fire({title:u[h()].nav_comment_submit,showConfirmButton:!1,icon:null,didOpen:()=>{v.showLoading(null),ee(j+"/comment/add",{method:"POST",params:a}).then(()=>{this.textInput="",v.fire({title:u[h()].nav_success,text:u[h()].nav_success_text_reply,icon:"success",timer:5e3,timerProgressBar:!0,showConfirmButton:!0,confirmButtonText:u[h()].nav_ok_1,showCloseButton:!0})}).catch(o=>{V(o),v.fire({title:u[h()].nav_failed,text:u[h()].nav_fail_reason+o.message,icon:"error",timer:5e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1})})}})}created(){this.textInputKey=`draft-${this.p.id}`,this.textInputCache=localStorage.getItem(this.textInputKey)??""}get textInput(){return this.textInputCache}set textInput(n){this.textInputCache=n,localStorage.setItem(this.textInputKey,n)}mounted(){this.resizeInput(),ne()}resizeInput(){const n=this.$refs.input;n.style.height="auto",n.style.height=`${n.scrollHeight+18}px`}};C=ke([P({components:{MarkdownTooltip:L,SubmitPrompt:R}})],C);const Ce={id:"TdorComments"},Pe={id:"add-comment"},$e=["placeholder"],Ie={key:0,id:"send-comment-btn"},xe={class:"char-count unselectable"};function Se(e,t,n,a,o,s){const r=te,y=L,c=R;return p(),d("div",Ce,[g(B,{name:"collapse"},{default:U(()=>[S(l("div",Pe,[S(l("textarea",{id:"comment-textarea","onUpdate:modelValue":t[0]||(t[0]=f=>e.textInput=f),placeholder:e.i18n.nav_comment_placeholder,onInput:t[1]||(t[1]=(...f)=>e.resizeInput&&e.resizeInput(...f)),ref:"input"},null,40,$e),[[K,e.textInput]]),e.textInput.length>0?(p(),d("div",Ie,[l("span",xe,b(e.textInput.length)+" "+b(e.i18n.nav_comment_status),1),g(r,{class:"icon",onClick:e.btnSend},null,8,["onClick"])])):m("",!0),g(y,{"text-area-id":"comment-textarea"})],512),[[Y,e.showInputArea]])]),_:1}),e.showCaptchaPrompt?(p(),H(c,{key:0,onSubmit:e.submitRequest,onClose:t[2]||(t[2]=f=>e.showCaptchaPrompt=!1)},null,8,["onSubmit"])):m("",!0)])}const qe=I(C,[["render",Se]]);var Ae=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,x=(e,t,n,a)=>{for(var o=a>1?void 0:a?ze(t,n):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(a?r(t,n,o):r(o))||o);return a&&o&&Ae(t,n,o),o};let w=class extends ${constructor(){super(...arguments);i(this,"clicked","");i(this,"showAdd",!1);i(this,"lang",h());i(this,"tdorTop",T(this.lang==="zh_hans"?de:this.lang==="zh_hant"?ce:ue));i(this,"htmlTop",T(this.lang==="zh_hans"?me:this.lang==="zh_hant"?fe:ge));i(this,"htmlBottom",T(this.lang==="zh_hans"?we:this.lang==="zh_hant"?ve:_e));i(this,"people",null);i(this,"bookmarkTexts");i(this,"bookmark")}isDeadlinePassed(){const n=new Date(2024,2,27,16,0);return new Date>n}updated(){if(this.bookmark!=null){const n=this.bookmark[0].offsetWidth-10;for(const a of this.bookmarkTexts)be(a,{width:n})}}created(){_(`Language: ${this.lang}`),M(A(z,"people-list.json")).then(n=>n.text()).then(n=>{this.people=JSON.parse(n)})}switchPage(n){_(`switchPage(${n.id})`),this.$router.push(`/profile/${n.id}`)}profileUrl(n){return G(n.profileUrl,n.id)}};x([D()],w.prototype,"bookmarkTexts",2);x([D()],w.prototype,"bookmark",2);w=x([P({components:{TdorComments:qe}})],w);const F=e=>(O("data-v-20abec42"),e=e(),E(),e),Oe=["innerHTML"],Ee=["innerHTML"],Ue={key:2,id:"profiles",class:"unselectable"},Be=F(()=>l("div",{class:"back"},null,-1)),He=["href","onClick"],Me=["src","onClick"],Le={key:0,class:"profile"},De=F(()=>l("div",{class:"back add fbox-vcenter"},"+",-1)),Re=[De],Fe=["innerHTML"];function Ne(e,t,n,a,o,s){const r=J("TdorComments"),y=he;return p(),d("div",null,[l("div",{id:"home",class:Z(e.clicked?"clicked":"")},[e.isDeadlinePassed()?m("",!0):(p(),d("div",{key:0,class:"introduction markdown-content",innerHTML:e.tdorTop},null,8,Oe)),e.isDeadlinePassed()?m("",!0):(p(),H(r,{key:1})),l("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,Ee),g(y),e.people?(p(),d("div",Ue,[(p(!0),d(X,null,Q(e.people,(c,f)=>(p(),d("div",{class:"profile",key:f},[Be,l("a",{href:`/profile/${c.id}`,onClick:q(()=>!1,["exact","prevent","stop"])},[g(B,{name:"fade",onAfterLeave:()=>e.switchPage(c)},{default:U(()=>[e.clicked!==c.name?(p(),d("img",{key:0,src:e.profileUrl(c),draggable:"false",alt:"profile",class:"front clickable",onClick:q(()=>(e.clicked||(e.clicked=c.name),!1),["exact"])},null,8,Me)):m("",!0)]),_:2},1032,["onAfterLeave"])],8,He),l("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},b(c.name),513),l("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(p(),d("div",Le,Re)):m("",!0)])):m("",!0),l("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,Fe)],2)])}const Qe=I(w,[["render",Ne],["__scopeId","data-v-20abec42"]]);export{Qe as default};
