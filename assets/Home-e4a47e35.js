var v=Object.defineProperty;var y=(e,n,t)=>n in e?v(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var r=(e,n,t)=>(y(e,typeof n!="symbol"?n+"":n,t),t);import{V as k,g as _,i as m,u as T,d as x,r as E,O as q,_ as z,o as h,c as p,a as l,F as A,b as S,e as d,n as U,w as f,f as C,h as H,T as P,t as O,p as L,j as B}from"./index-da207e33.js";import{f as W}from"./helper-da2ecf09.js";import{R as g}from"./Ref-d33b005b.js";const F=`<blockquote>
...
`,R=`<h1 id="拒绝对跨性别的暴力">拒绝对跨性别的暴力</h1>
...
`,M=`<h1 id="拒絕對跨性別的暴力">拒絕對跨性別的暴力</h1>
...
`;function V(e,n={}){if(e.hasAttribute("fit-initialized"))return;function t(){const a=n.width??e.parentElement.clientWidth;if(e.clientWidth<=a)return;const o=window.getComputedStyle(e);let i=a/e.clientWidth*parseFloat(o.fontSize);e.style.height=e.clientHeight+"px",n.maxFontSize&&(i=Math.min(i,n.maxFontSize)),n.minFontSize&&(i=Math.max(i,n.minFontSize)),e.style.fontSize=i+"px"}t(),e.addEventListener("resize",t),e.addEventListener("orientationchange",t),e.setAttribute("fit-initialized","y")}var j=Object.defineProperty,D=Object.getOwnPropertyDescriptor,u=(e,n,t,a)=>{for(var o=a>1?void 0:a?D(n,t):n,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(n,t,o):s(o))||o);return a&&o&&j(n,t,o),o};let c=class extends k{constructor(){super(...arguments);r(this,"clicked","");r(this,"showAdd",!1);r(this,"lang",_());r(this,"htmlTop",this.lang==="zh_hans"?F:this.lang==="zh_hant"?I:N);r(this,"htmlBottom",this.lang==="zh_hans"?R:this.lang==="zh_hant"?M:$);r(this,"people",null);r(this,"bookmarkTexts");r(this,"bookmark")}updated(){if(this.bookmark!=null){const t=this.bookmark[0].offsetWidth-10;for(const a of this.bookmarkTexts)V(a,{width:t})}}created(){m(`Language: ${this.lang}`),W(T(x,"people-list.json")).then(t=>t.text()).then(t=>{this.people=JSON.parse(t)})}switchPage(t){m(`switchPage(${t.id})`),this.$router.push(`/profile/${t.id}`)}profileUrl(t){return E(t.profileUrl,t.id)}};u([g()],c.prototype,"bookmarkTexts",2);u([g()],c.prototype,"bookmark",2);c=u([q({})],c);const w=e=>(L("data-v-02c7ee79"),e=e(),B(),e),G=["innerHTML"],J={key:0,id:"profiles",class:"unselectable"},Y=w(()=>l("div",{class:"back"},null,-1)),K=["href","onClick"],Q=["src","onClick"],X={key:0,class:"profile"},Z=w(()=>l("div",{class:"back add fbox-vcenter"},"+",-1)),ee=[Z],te=["innerHTML"];function ne(e,n,t,a,o,i){return h(),p("div",null,[l("div",{id:"home",class:U(e.clicked?"clicked":"")},[l("div",{class:"introduction markdown-content",innerHTML:e.htmlTop},null,8,G),e.people?(h(),p("div",J,[(h(!0),p(A,null,S(e.people,(s,b)=>(h(),p("div",{class:"profile",key:b},[Y,l("a",{href:`/profile/${s.id}`,onClick:f(()=>!1,["exact","prevent","stop"])},[C(P,{name:"fade",onAfterLeave:()=>e.switchPage(s)},{default:H(()=>[e.clicked!==s.name?(h(),p("img",{key:0,src:e.profileUrl(s),draggable:"false",alt:"profile",class:"front clickable",onClick:f(()=>(e.clicked||(e.clicked=s.name),!1),["exact"])},null,8,Q)):d("",!0)]),_:2},1032,["onAfterLeave"])],8,K),l("div",{class:"name font-custom",ref_for:!0,ref:"bookmarkTexts"},O(s.name),513),l("div",{class:"bookmark",ref_for:!0,ref:"bookmark"},null,512)]))),128)),e.showAdd?(h(),p("div",X,ee)):d("",!0)])):d("",!0),l("div",{class:"introduction markdown-content",innerHTML:e.htmlBottom},null,8,te)],2)])}const le=z(c,[["render",ne],["__scopeId","data-v-02c7ee79"]]);export{le as default};
